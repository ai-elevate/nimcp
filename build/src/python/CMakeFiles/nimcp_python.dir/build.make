...
lib/python/nimcp.so: lib/libnimcp.so.0.9.0
lib/python/nimcp.so: /usr/lib/x86_64-linux-gnu/libpython3.12.so
lib/python/nimcp.so: /usr/local/cuda/lib64/libcudart.so
lib/python/nimcp.so: /usr/local/cuda/lib64/libcufft.so
lib/python/nimcp.so: /usr/local/cuda/lib64/libcurand.so
lib/python/nimcp.so: /usr/local/cuda/lib64/libcusolver.so
lib/python/nimcp.so: /usr/local/cuda/lib64/libcublas.so
lib/python/nimcp.so: /usr/local/cuda/lib64/libculibos.a
lib/python/nimcp.so: /usr/local/cuda/lib64/libcublasLt.so
lib/python/nimcp.so: /usr/local/cuda/lib64/libcusparse.so
lib/python/nimcp.so: /usr/local/cuda/lib64/libnvJitLink.so
lib/python/nimcp.so: /usr/lib/x86_64-linux-gnu/libcurl.so
