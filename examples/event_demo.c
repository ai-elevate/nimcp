 ...
 */
static void event_generated_callback(const event_packet_t* packet,
                                    const void* payload,
...
int main(void) {
    ...
    event_generator_set_neuron_feature(generator, 0,
        MAKE_FEATURE_CODE(FEATURE_DOMAIN_VISION, 0x0001)); // Edge detection
    event_generator_set_neuron_feature(generator, 1,
        MAKE_FEATURE_CODE(FEATURE_DOMAIN_VISION, 0x0002)); // Vertical edge
    event_generator_set_neuron_feature(generator, 2,
        MAKE_FEATURE_CODE(FEATURE_DOMAIN_VISION, 0x1000)); // Motion detection
    ...
    printf("  Filter 1: Vision domain (0x%06X, mask 0x%06X)\n",
           vision_filter.feature_code, vision_filter.feature_mask);
    printf("  Filter 2: Edge detection (0x%06X, mask 0x%06X)\n\n",
           edge_filter.feature_code, edge_filter.feature_mask);
    ...
    event_receiver_map_feature_to_neuron(receiver,
        MAKE_FEATURE_CODE(FEATURE_DOMAIN_VISION, 0x0001), 5);
    event_receiver_map_feature_to_neuron(receiver,
        MAKE_FEATURE_CODE(FEATURE_DOMAIN_VISION, 0x0002), 6);
    ...
    printf("  Neurons: %u (E: %u, I: %u)\n",
           stats.num_neurons, stats.num_excitatory, stats.num_inhibitory);
