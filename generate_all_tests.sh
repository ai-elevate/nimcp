...
echo "Generating comprehensive test suite for middleware..."

# Test for Circular Buffer (30+ tests)
cat > /home/bbrelin/nimcp/test/unit/middleware/buffering/test_circular_buffer.cpp << 'EOF'
...
echo "Circular buffer tests created (30 tests)"

# Generate remaining test files more concisely due to length
