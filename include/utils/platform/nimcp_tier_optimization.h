 ...
 *
 * Set via: -DNIMCP_BUILD_TIER=PLATFORM_TIER_MINIMAL
 * If not set, defaults to PLATFORM_TIER_FULL
 */
#ifndef NIMCP_BUILD_TIER
    #define NIMCP_BUILD_TIER PLATFORM_TIER_FULL
#endif
 ...
 */
#if NIMCP_BUILD_TIER == PLATFORM_TIER_MINIMAL || NIMCP_BUILD_TIER == PLATFORM_TIER_CONSTRAINED
