...
/** Global health agent for api_network module */
static nimcp_health_agent_t* g_api_network_health_agent = NULL;

/**
 * @brief Set health agent for api_network heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void api_network_set_health_agent(nimcp_health_agent_t* agent) {
    g_api_network_health_agent = agent;
}

/** @brief Send heartbeat from api_network module */
static inline void api_network_heartbeat(const char* operation, float progress) {
    if (g_api_network_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_api_network_health_agent, operation, progress);
    }
}
