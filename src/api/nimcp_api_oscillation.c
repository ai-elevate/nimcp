...
/** Global health agent for api_oscillation module */
static nimcp_health_agent_t* g_api_oscillation_health_agent = NULL;

/**
 * @brief Set health agent for api_oscillation heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void api_oscillation_set_health_agent(nimcp_health_agent_t* agent) {
    g_api_oscillation_health_agent = agent;
}

/** @brief Send heartbeat from api_oscillation module */
static inline void api_oscillation_heartbeat(const char* operation, float progress) {
    if (g_api_oscillation_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_api_oscillation_health_agent, operation, progress);
    }
}
