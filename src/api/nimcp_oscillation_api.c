...
/** Global health agent for oscillation_api module */
static nimcp_health_agent_t* g_oscillation_api_health_agent = NULL;

/**
 * @brief Set health agent for oscillation_api heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void oscillation_api_set_health_agent(nimcp_health_agent_t* agent) {
    g_oscillation_api_health_agent = agent;
}

/** @brief Send heartbeat from oscillation_api module */
static inline void oscillation_api_heartbeat(const char* operation, float progress) {
    if (g_oscillation_api_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_oscillation_api_health_agent, operation, progress);
    }
}
