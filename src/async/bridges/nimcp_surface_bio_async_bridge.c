...
/** Global health agent for surface_bio_async_bridge module */
static nimcp_health_agent_t* g_surface_bio_async_bridge_health_agent = NULL;

/**
 * @brief Set health agent for surface_bio_async_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void surface_bio_async_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_surface_bio_async_bridge_health_agent = agent;
}

/** @brief Send heartbeat from surface_bio_async_bridge module */
static inline void surface_bio_async_bridge_heartbeat(const char* operation, float progress) {
    if (g_surface_bio_async_bridge_health_agent) {
