...
/** Global health agent for async_integration_bridge module */
static nimcp_health_agent_t* g_async_integration_bridge_health_agent = NULL;

/**
 * @brief Set health agent for async_integration_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void async_integration_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_async_integration_bridge_health_agent = agent;
}

/** @brief Send heartbeat from async_integration_bridge module */
static inline void async_integration_bridge_heartbeat(const char* operation, float progress) {
    if (g_async_integration_bridge_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_async_integration_bridge_health_agent, operation, progress);
    }
}
