...
/** Global health agent for ph_dynamics module */
static nimcp_health_agent_t* g_ph_dynamics_health_agent = NULL;

/**
 * @brief Set health agent for ph_dynamics heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void ph_dynamics_set_health_agent(nimcp_health_agent_t* agent) {
    g_ph_dynamics_health_agent = agent;
}

/** @brief Send heartbeat from ph_dynamics module */
static inline void ph_dynamics_heartbeat(const char* operation, float progress) {
    if (g_ph_dynamics_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_ph_dynamics_health_agent, operation, progress);
    }
}
