...
/** Global health agent for proton_pumps module */
static nimcp_health_agent_t* g_proton_pumps_health_agent = NULL;

/**
 * @brief Set health agent for proton_pumps heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void proton_pumps_set_health_agent(nimcp_health_agent_t* agent) {
    g_proton_pumps_health_agent = agent;
}

/** @brief Send heartbeat from proton_pumps module */
static inline void proton_pumps_heartbeat(const char* operation, float progress) {
    if (g_proton_pumps_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_proton_pumps_health_agent, operation, progress);
    }
}
