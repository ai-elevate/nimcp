...
/** Global health agent for analysis_fep_bridge module */
static nimcp_health_agent_t* g_analysis_fep_bridge_health_agent = NULL;

/**
 * @brief Set health agent for analysis_fep_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void analysis_fep_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_analysis_fep_bridge_health_agent = agent;
}

/** @brief Send heartbeat from analysis_fep_bridge module */
static inline void analysis_fep_bridge_heartbeat(const char* operation, float progress) {
