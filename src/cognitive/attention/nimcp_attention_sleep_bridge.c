...
/** Global health agent for attention_sleep_bridge module */
static nimcp_health_agent_t* g_attention_sleep_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from attention_sleep_bridge module */
static inline void attention_sleep_bridge_heartbeat(const char* operation, float progress) {
