...
/** Global health agent for emotion_attention module */
static nimcp_health_agent_t* g_emotion_attention_health_agent = NULL;
...
/** @brief Send heartbeat from emotion_attention module */
static inline void emotion_attention_heartbeat(const char* operation, float progress) {
