...
/** Global health agent for autobio_plasticity_bridge module */
static nimcp_health_agent_t* g_autobio_plasticity_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from autobio_plasticity_bridge module */
static inline void autobio_plasticity_bridge_heartbeat(const char* operation, float progress) {
