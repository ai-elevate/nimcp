...
/** Global health agent for autobiographical_fep_bridge module */
static nimcp_health_agent_t* g_autobiographical_fep_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from autobiographical_fep_bridge module */
static inline void autobiographical_fep_bridge_heartbeat(const char* operation, float progress) {
