...
/** Global health agent for autobiographical_memory_sleep_bridge module */
static nimcp_health_agent_t* g_autobiographical_memory_sleep_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from autobiographical_memory_sleep_bridge module */
static inline void autobiographical_memory_sleep_bridge_heartbeat(const char* operation, float progress) {
