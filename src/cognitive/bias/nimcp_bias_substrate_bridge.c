...
void bias_substrate_bridge_destroy(bias_substrate_bridge_t* bridge) { if (bridge) nimcp_free(bridge); }
...
int bias_substrate_bridge_apply_effects(bias_substrate_bridge_t* bridge) { return bridge ? 0 : -1; }
