...
/** Global health agent for collective_cognition module */
static nimcp_health_agent_t* g_collective_cognition_health_agent = NULL;
...
/** @brief Send heartbeat from collective_cognition module */
static inline void collective_cognition_heartbeat(const char* operation, float progress) {
