...
/** Global health agent for collective_phi module */
static nimcp_health_agent_t* g_collective_phi_health_agent = NULL;
...
/** @brief Send heartbeat from collective_phi module */
static inline void collective_phi_heartbeat(const char* operation, float progress) {
