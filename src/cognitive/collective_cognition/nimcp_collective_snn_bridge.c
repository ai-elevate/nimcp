...
/** Global health agent for collective_snn_bridge module */
static nimcp_health_agent_t* g_collective_snn_bridge_health_agent = NULL;

/**
 * @brief Set health agent for collective_snn_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void collective_snn_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_collective_snn_bridge_health_agent = agent;
}

/** @brief Send heartbeat from collective_snn_bridge module */
static inline void collective_snn_bridge_heartbeat(const char* operation, float progress) {
