...
/** Global health agent for extended_mind module */
static nimcp_health_agent_t* g_extended_mind_health_agent = NULL;
...
/** @brief Send heartbeat from extended_mind module */
static inline void extended_mind_heartbeat(const char* operation, float progress) {
