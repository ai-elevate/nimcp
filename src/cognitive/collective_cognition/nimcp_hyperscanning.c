...
/** Global health agent for hyperscanning module */
static nimcp_health_agent_t* g_hyperscanning_health_agent = NULL;
...
/** @brief Send heartbeat from hyperscanning module */
static inline void hyperscanning_heartbeat(const char* operation, float progress) {
