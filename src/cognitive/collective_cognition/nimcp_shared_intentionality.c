...
/** Global health agent for shared_intentionality module */
static nimcp_health_agent_t* g_shared_intentionality_health_agent = NULL;
...
/** @brief Send heartbeat from shared_intentionality module */
static inline void shared_intentionality_heartbeat(const char* operation, float progress) {
