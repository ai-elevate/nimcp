...
/** Global health agent for metabolic_modulation module */
static nimcp_health_agent_t* g_metabolic_modulation_health_agent = NULL;
...
/** @brief Send heartbeat from metabolic_modulation module */
static inline void metabolic_modulation_heartbeat(const char* operation, float progress) {
