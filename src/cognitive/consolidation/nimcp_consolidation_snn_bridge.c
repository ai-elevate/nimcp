...
/** Global health agent for consolidation_snn_bridge module */
static nimcp_health_agent_t* g_consolidation_snn_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from consolidation_snn_bridge module */
static inline void consolidation_snn_bridge_heartbeat(const char* operation, float progress) {
    if (g_consolidation_snn_bridge_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_consolidation_snn_bridge_health_agent, operation, progress);
    }
}
