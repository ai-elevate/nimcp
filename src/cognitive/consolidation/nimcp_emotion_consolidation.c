...
/** Global health agent for emotion_consolidation module */
static nimcp_health_agent_t* g_emotion_consolidation_health_agent = NULL;
...
/** @brief Send heartbeat from emotion_consolidation module */
static inline void emotion_consolidation_heartbeat(const char* operation, float progress) {
