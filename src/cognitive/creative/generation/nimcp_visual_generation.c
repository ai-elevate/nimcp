...
/** Global health agent for visual_generation module */
static nimcp_health_agent_t* g_visual_generation_health_agent = NULL;

/**
 * @brief Set health agent for visual_generation heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
void visual_generation_set_health_agent(nimcp_health_agent_t* agent) {
    g_visual_generation_health_agent = agent;
}

/** @brief Send heartbeat from visual_generation module */
static inline void visual_generation_heartbeat(const char* operation, float progress) {
    if (g_visual_generation_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_visual_generation_health_agent, operation, progress);
    }
}
