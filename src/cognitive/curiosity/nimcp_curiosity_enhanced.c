...
/** Global health agent for curiosity_enhanced module */
static nimcp_health_agent_t* g_curiosity_enhanced_health_agent = NULL;
...
/** @brief Send heartbeat from curiosity_enhanced module */
static inline void curiosity_enhanced_heartbeat(const char* operation, float progress) {
