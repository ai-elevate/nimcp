...
/** Global health agent for curiosity_fep_bridge module */
static nimcp_health_agent_t* g_curiosity_fep_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from curiosity_fep_bridge module */
static inline void curiosity_fep_bridge_heartbeat(const char* operation, float progress) {
