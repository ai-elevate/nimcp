...
/** Global health agent for curiosity_fractal module */
static nimcp_health_agent_t* g_curiosity_fractal_health_agent = NULL;
...
/** @brief Send heartbeat from curiosity_fractal module */
static inline void curiosity_fractal_heartbeat(const char* operation, float progress) {
