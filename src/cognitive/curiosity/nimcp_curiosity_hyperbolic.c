...
/** Global health agent for curiosity_hyperbolic module */
static nimcp_health_agent_t* g_curiosity_hyperbolic_health_agent = NULL;
...
/** @brief Send heartbeat from curiosity_hyperbolic module */
static inline void curiosity_hyperbolic_heartbeat(const char* operation, float progress) {
