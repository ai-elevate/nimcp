...
BRIDGE_BOILERPLATE(curiosity_plasticity_bridge, MESH_ADAPTER_CATEGORY_COGNITIVE)
...
curiosity_plasticity_bridge_t* curiosity_plasticity_create(
    ...
    bridge->exploration_state.novelty_sensitivity = NIMCP_SENSITIVITY_DEFAULT;
    bridge->exploration_state.exploration_calibration = 0.5f;
    bridge->exploration_state.info_gain_sensitivity = NIMCP_SENSITIVITY_DEFAULT;
