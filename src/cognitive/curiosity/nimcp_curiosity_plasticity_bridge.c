...
/** Global health agent for curiosity_plasticity_bridge module */
static nimcp_health_agent_t* g_curiosity_plasticity_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from curiosity_plasticity_bridge module */
static inline void curiosity_plasticity_bridge_heartbeat(const char* operation, float progress) {
