...
/** Global health agent for curiosity_sleep_bridge module */
static nimcp_health_agent_t* g_curiosity_sleep_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from curiosity_sleep_bridge module */
static inline void curiosity_sleep_bridge_heartbeat(const char* operation, float progress) {
