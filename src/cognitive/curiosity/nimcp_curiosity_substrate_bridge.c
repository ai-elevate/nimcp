...
/** Global health agent for curiosity_substrate_bridge module */
static nimcp_health_agent_t* g_curiosity_substrate_bridge_health_agent = NULL;

/**
 * @brief Set health agent for curiosity_substrate_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void curiosity_substrate_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_curiosity_substrate_bridge_health_agent = agent;
}

/** @brief Send heartbeat from curiosity_substrate_bridge module */
static inline void curiosity_substrate_bridge_heartbeat(const char* operation, float progress) {
