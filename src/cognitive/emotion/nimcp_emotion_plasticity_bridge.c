...
/** Global health agent for emotion_plasticity_bridge module */
static nimcp_health_agent_t* g_emotion_plasticity_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from emotion_plasticity_bridge module */
