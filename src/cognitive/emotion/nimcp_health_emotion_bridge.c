...
/** Global health agent for health_emotion_bridge module */
static nimcp_health_agent_t* g_health_emotion_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from health_emotion_bridge module */
static inline void health_emotion_bridge_heartbeat(const char* operation, float progress) {
