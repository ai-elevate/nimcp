...
/** Global health agent for emotion_recognition_fep_bridge module */
static nimcp_health_agent_t* g_emotion_recognition_fep_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from emotion_recognition_fep_bridge module */
static inline void emotion_recognition_fep_bridge_heartbeat(const char* operation, float progress) {
