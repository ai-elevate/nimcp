...
/** Global health agent for emotion_recognition_simple module */
static nimcp_health_agent_t* g_emotion_recognition_simple_health_agent = NULL;
...
/** @brief Send heartbeat from emotion_recognition_simple module */
static inline void emotion_recognition_simple_heartbeat(const char* operation, float progress) {
