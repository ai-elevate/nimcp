...
/** Global health agent for emotion_tensor module */
static nimcp_health_agent_t* g_emotion_tensor_health_agent = NULL;
...
/** @brief Send heartbeat from emotion_tensor module */
static inline void emotion_tensor_heartbeat(const char* operation, float progress) {
