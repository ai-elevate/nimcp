...
/** Global health agent for emotion_tensor_bridge module */
static nimcp_health_agent_t* g_emotion_tensor_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from emotion_tensor_bridge module */
static inline void emotion_tensor_bridge_heartbeat(const char* operation, float progress) {
