...
/** Global health agent for emotional_tagging_fep_bridge module */
static nimcp_health_agent_t* g_emotional_tagging_fep_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from emotional_tagging_fep_bridge module */
static inline void emotional_tagging_fep_bridge_heartbeat(const char* operation, float progress) {
