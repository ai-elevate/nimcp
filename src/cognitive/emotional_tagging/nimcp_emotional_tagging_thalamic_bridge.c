...
/** Global health agent for emotional_tagging_thalamic_bridge module */
static nimcp_health_agent_t* g_emotional_tagging_thalamic_bridge_health_agent = NULL;

/**
 * @brief Set health agent for emotional_tagging_thalamic_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void emotional_tagging_thalamic_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_emotional_tagging_thalamic_bridge_health_agent = agent;
}

/** @brief Send heartbeat from emotional_tagging_thalamic_bridge module */
static inline void emotional_tagging_thalamic_bridge_heartbeat(const char* operation, float progress) {
