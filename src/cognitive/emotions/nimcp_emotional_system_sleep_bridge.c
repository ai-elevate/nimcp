...
/** Global health agent for emotional_system_sleep_bridge module */
static nimcp_health_agent_t* g_emotional_system_sleep_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from emotional_system_sleep_bridge module */
static inline void emotional_system_sleep_bridge_heartbeat(const char* operation, float progress) {
