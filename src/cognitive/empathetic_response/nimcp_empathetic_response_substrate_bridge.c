...
/** Global health agent for empathetic_response_substrate_bridge module */
static nimcp_health_agent_t* g_empathetic_response_substrate_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from empathetic_response_substrate_bridge module */
static inline void empathetic_response_substrate_bridge_heartbeat(const char* operation, float progress) {
