...
/** Global health agent for epistemic_fep_bridge module */
static nimcp_health_agent_t* g_epistemic_fep_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from epistemic_fep_bridge module */
static inline void epistemic_fep_bridge_heartbeat(const char* operation, float progress) {
