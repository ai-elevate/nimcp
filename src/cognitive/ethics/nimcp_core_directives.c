...
/** Global health agent for core_directives module */
static nimcp_health_agent_t* g_core_directives_health_agent = NULL;
...
/** @brief Send heartbeat from core_directives module */
static inline void core_directives_heartbeat(const char* operation, float progress) {
