...
/** Global health agent for ethics module */
static nimcp_health_agent_t* g_ethics_health_agent = NULL;
...
/** @brief Send heartbeat from ethics module */
static inline void ethics_heartbeat(const char* operation, float progress) {
