...
/** Global health agent for ethics_evaluation module */
static nimcp_health_agent_t* g_ethics_evaluation_health_agent = NULL;
...
/** @brief Send heartbeat from ethics_evaluation module */
static inline void ethics_evaluation_heartbeat(const char* operation, float progress) {
