...
/** Global health agent for ethics_incidents module */
static nimcp_health_agent_t* g_ethics_incidents_health_agent = NULL;
...
/** @brief Send heartbeat from ethics_incidents module */
static inline void ethics_incidents_heartbeat(const char* operation, float progress) {
