...
/** Global health agent for ethics_plasticity_bridge module */
static nimcp_health_agent_t* g_ethics_plasticity_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from ethics_plasticity_bridge module */
static inline void ethics_plasticity_bridge_heartbeat(const char* operation, float progress) {
