...
/** Global health agent for ethics_snn_bridge module */
static nimcp_health_agent_t* g_ethics_snn_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from ethics_snn_bridge module */
static inline void ethics_snn_bridge_heartbeat(const char* operation, float progress) {
