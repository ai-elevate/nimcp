...
/** Global health agent for ethics_thalamic_bridge module */
static nimcp_health_agent_t* g_ethics_thalamic_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from ethics_thalamic_bridge module */
static inline void ethics_thalamic_bridge_heartbeat(const char* operation, float progress) {
