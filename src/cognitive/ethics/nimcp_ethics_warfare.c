...
/** Global health agent for ethics_warfare module */
static nimcp_health_agent_t* g_ethics_warfare_health_agent = NULL;
...
/** @brief Send heartbeat from ethics_warfare module */
static inline void ethics_warfare_heartbeat(const char* operation, float progress) {
