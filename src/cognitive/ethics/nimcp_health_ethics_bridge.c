...
/** Global health agent for health_ethics_bridge module */
static nimcp_health_agent_t* g_health_ethics_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from health_ethics_bridge module */
static inline void health_ethics_bridge_heartbeat(const char* operation, float progress) {
