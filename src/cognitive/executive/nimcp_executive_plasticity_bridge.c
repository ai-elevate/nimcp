...
/** Global health agent for executive_plasticity_bridge module */
static nimcp_health_agent_t* g_executive_plasticity_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from executive_plasticity_bridge module */
static inline void executive_plasticity_bridge_heartbeat(const char* operation, float progress) {
