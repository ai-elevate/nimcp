...
/** Global health agent for executive_thalamic_bridge module */
static nimcp_health_agent_t* g_executive_thalamic_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from executive_thalamic_bridge module */
static inline void executive_thalamic_bridge_heartbeat(const char* operation, float progress) {
