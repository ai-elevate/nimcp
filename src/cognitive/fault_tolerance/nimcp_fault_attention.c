...
/** Global health agent for fault_attention module */
static nimcp_health_agent_t* g_fault_attention_health_agent = NULL;
...
/** @brief Send heartbeat from fault_attention module */
static inline void fault_attention_heartbeat(const char* operation, float progress) {
