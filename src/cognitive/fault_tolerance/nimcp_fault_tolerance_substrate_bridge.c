...
/** Global health agent for fault_tolerance_substrate_bridge module */
static nimcp_health_agent_t* g_fault_tolerance_substrate_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from fault_tolerance_substrate_bridge module */
static inline void fault_tolerance_substrate_bridge_heartbeat(const char* operation, float progress) {
