...
/** Global health agent for health_self_repair_bridge module */
static nimcp_health_agent_t* g_health_self_repair_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from health_self_repair_bridge module */
static inline void health_self_repair_bridge_heartbeat(const char* operation, float progress) {
