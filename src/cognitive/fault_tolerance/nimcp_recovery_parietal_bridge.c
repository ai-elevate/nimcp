...
/** Global health agent for recovery_parietal_bridge module */
static nimcp_health_agent_t* g_recovery_parietal_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from recovery_parietal_bridge module */
static inline void recovery_parietal_bridge_heartbeat(const char* operation, float progress) {
