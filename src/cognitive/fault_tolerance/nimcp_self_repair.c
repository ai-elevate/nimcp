...
/** Global health agent for self_repair module */
static nimcp_health_agent_t* g_self_repair_health_agent = NULL;
...
/** @brief Send heartbeat from self_repair module */
static inline void self_repair_heartbeat(const char* operation, float progress) {
