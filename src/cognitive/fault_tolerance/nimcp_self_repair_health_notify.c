...
BRIDGE_BOILERPLATE(self_repair_health_notify, MESH_ADAPTER_CATEGORY_COGNITIVE)
...
typedef struct {
    ...
    char source_file[NIMCP_METRICS_PATH_SIZE];              /**< Affected source file */
    char function_name[NIMCP_LABEL_BUFFER_SIZE];            /**< Affected function */
