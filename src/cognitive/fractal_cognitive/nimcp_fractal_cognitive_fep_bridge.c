...
/** Global health agent for fractal_cognitive_fep_bridge module */
static nimcp_health_agent_t* g_fractal_cognitive_fep_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from fractal_cognitive_fep_bridge module */
static inline void fractal_cognitive_fep_bridge_heartbeat(const char* operation, float progress) {
