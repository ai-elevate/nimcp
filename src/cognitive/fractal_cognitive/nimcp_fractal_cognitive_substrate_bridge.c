...
/** Global health agent for fractal_cognitive_substrate_bridge module */
static nimcp_health_agent_t* g_fractal_cognitive_substrate_bridge_health_agent = NULL;

/**
 * @brief Set health agent for fractal_cognitive_substrate_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
void fractal_cognitive_substrate_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_fractal_cognitive_substrate_bridge_health_agent = agent;
}

/** @brief Send heartbeat from fractal_cognitive_substrate_bridge module */
static inline void fractal_cognitive_substrate_bridge_heartbeat(const char* operation, float progress) {
