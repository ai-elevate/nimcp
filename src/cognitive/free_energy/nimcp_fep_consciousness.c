...
/** Global health agent for fep_consciousness module */
static nimcp_health_agent_t* g_fep_consciousness_health_agent = NULL;
...
/** @brief Send heartbeat from fep_consciousness module */
static inline void fep_consciousness_heartbeat(const char* operation, float progress) {
