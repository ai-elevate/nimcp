 ...
 */
static void free_energy_substrate_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_free_energy_substrate_bridge_health_agent = agent;
}

/** @brief Send heartbeat from free_energy_substrate_bridge module */
static inline void free_energy_substrate_bridge_heartbeat(const char* operation, float progress) {
