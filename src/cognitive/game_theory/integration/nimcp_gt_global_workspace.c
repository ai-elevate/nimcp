...
/** Global health agent for gt_global_workspace module */
static nimcp_health_agent_t* g_gt_global_workspace_health_agent = NULL;
...
/** @brief Send heartbeat from gt_global_workspace module */
static inline void gt_global_workspace_heartbeat(const char* operation, float progress) {
