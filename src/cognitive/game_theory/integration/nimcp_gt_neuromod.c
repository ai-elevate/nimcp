...
/** Global health agent for gt_neuromod module */
static nimcp_health_agent_t* g_gt_neuromod_health_agent = NULL;
...
/** @brief Send heartbeat from gt_neuromod module */
static inline void gt_neuromod_heartbeat(const char* operation, float progress) {
