...
/** Global health agent for gt_tom module */
static nimcp_health_agent_t* g_gt_tom_health_agent = NULL;
...
/** @brief Send heartbeat from gt_tom module */
static inline void gt_tom_heartbeat(const char* operation, float progress) {
