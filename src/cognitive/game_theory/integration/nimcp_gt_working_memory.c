...
/** Global health agent for gt_working_memory module */
static nimcp_health_agent_t* g_gt_working_memory_health_agent = NULL;
...
/** @brief Send heartbeat from gt_working_memory module */
static inline void gt_working_memory_heartbeat(const char* operation, float progress) {
