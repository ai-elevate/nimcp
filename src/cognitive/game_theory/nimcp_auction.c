...
/** Global health agent for auction module */
static nimcp_health_agent_t* g_auction_health_agent = NULL;
...
/** @brief Send heartbeat from auction module */
static inline void auction_heartbeat(const char* operation, float progress) {
