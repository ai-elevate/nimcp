...
/** Global health agent for bargaining module */
static nimcp_health_agent_t* g_bargaining_health_agent = NULL;
...
/** @brief Send heartbeat from bargaining module */
static inline void bargaining_heartbeat(const char* operation, float progress) {
