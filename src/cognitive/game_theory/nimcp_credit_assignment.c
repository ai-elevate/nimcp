...
/** Global health agent for credit_assignment module */
static nimcp_health_agent_t* g_credit_assignment_health_agent = NULL;
...
/** @brief Send heartbeat from credit_assignment module */
static inline void credit_assignment_heartbeat(const char* operation, float progress) {
