...
/** Global health agent for game_theory module */
static nimcp_health_agent_t* g_game_theory_health_agent = NULL;
...
/** @brief Send heartbeat from game_theory module */
static inline void game_theory_heartbeat(const char* operation, float progress) {
