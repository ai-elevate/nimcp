...
/** Global health agent for game_theory_fep_bridge module */
static nimcp_health_agent_t* g_game_theory_fep_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from game_theory_fep_bridge module */
static inline void game_theory_fep_bridge_heartbeat(const char* operation, float progress) {
