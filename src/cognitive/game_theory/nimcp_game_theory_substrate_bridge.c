...
/** Global health agent for game_theory_substrate_bridge module */
static nimcp_health_agent_t* g_game_theory_substrate_bridge_health_agent = NULL;

/**
 * @brief Set health agent for game_theory_substrate_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void game_theory_substrate_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_game_theory_substrate_bridge_health_agent = agent;
}

/** @brief Send heartbeat from game_theory_substrate_bridge module */
static inline void game_theory_substrate_bridge_heartbeat(const char* operation, float progress) {
