...
/** Global health agent for gt_auction_ext module */
static nimcp_health_agent_t* g_gt_auction_ext_health_agent = NULL;
...
/** @brief Send heartbeat from gt_auction_ext module */
static inline void gt_auction_ext_heartbeat(const char* operation, float progress) {
