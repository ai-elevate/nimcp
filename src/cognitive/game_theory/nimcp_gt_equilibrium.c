...
/** Global health agent for gt_equilibrium module */
static nimcp_health_agent_t* g_gt_equilibrium_health_agent = NULL;
...
/** @brief Send heartbeat from gt_equilibrium module */
static inline void gt_equilibrium_heartbeat(const char* operation, float progress) {
