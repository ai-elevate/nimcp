...
/** Global health agent for gt_fairness module */
static nimcp_health_agent_t* g_gt_fairness_health_agent = NULL;
...
/** @brief Send heartbeat from gt_fairness module */
static inline void gt_fairness_heartbeat(const char* operation, float progress) {
