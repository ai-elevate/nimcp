...
/** Global health agent for gt_learning module */
static nimcp_health_agent_t* g_gt_learning_health_agent = NULL;
...
/** @brief Send heartbeat from gt_learning module */
static inline void gt_learning_heartbeat(const char* operation, float progress) {
