...
/** Global health agent for gt_repeated module */
static nimcp_health_agent_t* g_gt_repeated_health_agent = NULL;
...
/** @brief Send heartbeat from gt_repeated module */
static inline void gt_repeated_heartbeat(const char* operation, float progress) {
