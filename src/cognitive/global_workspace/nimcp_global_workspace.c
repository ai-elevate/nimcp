...
/** Global health agent for global_workspace module */
static nimcp_health_agent_t* g_global_workspace_health_agent = NULL;
...
/** @brief Send heartbeat from global_workspace module */
static inline void global_workspace_heartbeat(const char* operation, float progress) {
