...
/** Global health agent for global_workspace_fep_bridge module */
static nimcp_health_agent_t* g_global_workspace_fep_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from global_workspace_fep_bridge module */
static inline void global_workspace_fep_bridge_heartbeat(const char* operation, float progress) {
