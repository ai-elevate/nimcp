...
/** Global health agent for grief_substrate_bridge module */
static nimcp_health_agent_t* g_grief_substrate_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from grief_substrate_bridge module */
static inline void grief_substrate_bridge_heartbeat(const char* operation, float progress) {
