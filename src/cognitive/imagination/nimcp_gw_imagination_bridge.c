...
/** Global health agent for gw_imagination_bridge module */
static nimcp_health_agent_t* g_gw_imagination_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from gw_imagination_bridge module */
static inline void gw_imagination_bridge_heartbeat(const char* operation, float progress) {
