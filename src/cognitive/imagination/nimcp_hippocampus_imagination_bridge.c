...
/** Global health agent for hippocampus_imagination_bridge module */
static nimcp_health_agent_t* g_hippocampus_imagination_bridge_health_agent = NULL;

/**
 * @brief Set health agent for hippocampus_imagination_bridge heartbeats
...
/** @brief Send heartbeat from hippocampus_imagination_bridge module */
static inline void hippocampus_imagination_bridge_heartbeat(const char* operation, float progress) {
