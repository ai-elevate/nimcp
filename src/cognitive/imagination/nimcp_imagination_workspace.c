...
/** Global health agent for imagination_workspace module */
static nimcp_health_agent_t* g_imagination_workspace_health_agent = NULL;
...
/** @brief Send heartbeat from imagination_workspace module */
static inline void imagination_workspace_heartbeat(const char* operation, float progress) {
