...
/** Global health agent for jepa_imagination_bridge module */
static nimcp_health_agent_t* g_jepa_imagination_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from jepa_imagination_bridge module */
static inline void jepa_imagination_bridge_heartbeat(const char* operation, float progress) {
