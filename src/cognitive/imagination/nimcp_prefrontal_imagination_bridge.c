...
/** Global health agent for prefrontal_imagination_bridge module */
static nimcp_health_agent_t* g_prefrontal_imagination_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from prefrontal_imagination_bridge module */
static inline void prefrontal_imagination_bridge_heartbeat(const char* operation, float progress) {
