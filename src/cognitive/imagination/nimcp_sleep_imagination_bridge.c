...
/** Global health agent for sleep_imagination_bridge module */
static nimcp_health_agent_t* g_sleep_imagination_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from sleep_imagination_bridge module */
static inline void sleep_imagination_bridge_heartbeat(const char* operation, float progress) {
