...
/** Global health agent for brain_immune module */
static nimcp_health_agent_t* g_brain_immune_health_agent = NULL;
...
/** @brief Send heartbeat from brain_immune module */
static inline void brain_immune_heartbeat(const char* operation, float progress) {
