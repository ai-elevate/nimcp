...
/** Global health agent for brain_immune_fep_bridge module */
static nimcp_health_agent_t* g_brain_immune_fep_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from brain_immune_fep_bridge module */
static inline void brain_immune_fep_bridge_heartbeat(const char* operation, float progress) {
