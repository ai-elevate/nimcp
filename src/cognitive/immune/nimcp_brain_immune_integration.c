...
/** Global health agent for brain_immune_integration module */
static nimcp_health_agent_t* g_brain_immune_integration_health_agent = NULL;

/**
 * @brief Set health agent for brain_immune_integration heartbeats
...
/** @brief Send heartbeat from brain_immune_integration module */
static inline void brain_immune_integration_heartbeat(const char* operation, float progress) {
