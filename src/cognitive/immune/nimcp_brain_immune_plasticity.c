...
/** Global health agent for brain_immune_plasticity module */
static nimcp_health_agent_t* g_brain_immune_plasticity_health_agent = NULL;
...
/** @brief Send heartbeat from brain_immune_plasticity module */
static inline void brain_immune_plasticity_heartbeat(const char* operation, float progress) {
