...
/** Global health agent for claude_healer module */
static nimcp_health_agent_t* g_claude_healer_health_agent = NULL;
...
/** @brief Send heartbeat from claude_healer module */
static inline void claude_healer_heartbeat(const char* operation, float progress) {
