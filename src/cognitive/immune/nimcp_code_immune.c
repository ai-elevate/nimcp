...
/** Global health agent for code_immune module */
static nimcp_health_agent_t* g_code_immune_health_agent = NULL;
...
/** @brief Send heartbeat from code_immune module */
static inline void code_immune_heartbeat(const char* operation, float progress) {
