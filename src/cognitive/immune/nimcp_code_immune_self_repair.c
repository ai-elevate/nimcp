...
/** Global health agent for code_immune_self_repair module */
static nimcp_health_agent_t* g_code_immune_self_repair_health_agent = NULL;
...
/** @brief Send heartbeat from code_immune_self_repair module */
static inline void code_immune_self_repair_heartbeat(const char* operation, float progress) {
