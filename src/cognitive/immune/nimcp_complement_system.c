...
/** Global health agent for complement_system module */
static nimcp_health_agent_t* g_complement_system_health_agent = NULL;
...
/** @brief Send heartbeat from complement_system module */
static inline void complement_system_heartbeat(const char* operation, float progress) {
