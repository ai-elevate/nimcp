...
/** Global health agent for curiosity_immune_bridge module */
static nimcp_health_agent_t* g_curiosity_immune_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from curiosity_immune_bridge module */
static inline void curiosity_immune_bridge_heartbeat(const char* operation, float progress) {
