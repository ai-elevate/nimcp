...
/** Global health agent for emotion_immune_bridge module */
static nimcp_health_agent_t* g_emotion_immune_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from emotion_immune_bridge module */
static inline void emotion_immune_bridge_heartbeat(const char* operation, float progress) {
