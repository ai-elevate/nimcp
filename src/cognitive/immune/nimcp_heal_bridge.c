...
/** Global health agent for heal_bridge module */
static nimcp_health_agent_t* g_heal_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from heal_bridge module */
static inline void heal_bridge_heartbeat(const char* operation, float progress) {
