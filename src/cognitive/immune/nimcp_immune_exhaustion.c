...
/** Global health agent for immune_exhaustion module */
static nimcp_health_agent_t* g_immune_exhaustion_health_agent = NULL;
...
/** @brief Send heartbeat from immune_exhaustion module */
static inline void immune_exhaustion_heartbeat(const char* operation, float progress) {
