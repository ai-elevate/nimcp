...
/** Global health agent for immune_persistence module */
static nimcp_health_agent_t* g_immune_persistence_health_agent = NULL;
...
/** @brief Send heartbeat from immune_persistence module */
static inline void immune_persistence_heartbeat(const char* operation, float progress) {
