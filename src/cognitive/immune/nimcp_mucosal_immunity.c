...
/** Global health agent for mucosal_immunity module */
static nimcp_health_agent_t* g_mucosal_immunity_health_agent = NULL;
...
/** @brief Send heartbeat from mucosal_immunity module */
static inline void mucosal_immunity_heartbeat(const char* operation, float progress) {
