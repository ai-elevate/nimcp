...
/** Global health agent for perception_immune module */
static nimcp_health_agent_t* g_perception_immune_health_agent = NULL;
...
/** @brief Send heartbeat from perception_immune module */
static inline void perception_immune_heartbeat(const char* operation, float progress) {
