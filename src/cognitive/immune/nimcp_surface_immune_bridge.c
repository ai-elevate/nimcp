...
/** Global health agent for surface_immune_bridge module */
static nimcp_health_agent_t* g_surface_immune_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from surface_immune_bridge module */
static inline void surface_immune_bridge_heartbeat(const char* operation, float progress) {
