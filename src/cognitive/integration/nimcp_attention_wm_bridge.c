...
/** Global health agent for attention_wm_bridge module */
static nimcp_health_agent_t* g_attention_wm_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from attention_wm_bridge module */
static inline void attention_wm_bridge_heartbeat(const char* operation, float progress) {
