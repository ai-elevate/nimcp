...
/** Global health agent for cognitive_integration_hub module */
static nimcp_health_agent_t* g_cognitive_integration_hub_health_agent = NULL;
...
/** @brief Send heartbeat from cognitive_integration_hub module */
static inline void cognitive_integration_hub_heartbeat(const char* operation, float progress) {
