...
/** Global health agent for collective_hub_bridge module */
static nimcp_health_agent_t* g_collective_hub_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from collective_hub_bridge module */
static inline void collective_hub_bridge_heartbeat(const char* operation, float progress) {
