...
/** Global health agent for emotion_executive_bridge module */
static nimcp_health_agent_t* g_emotion_executive_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from emotion_executive_bridge module */
static inline void emotion_executive_bridge_heartbeat(const char* operation, float progress) {
