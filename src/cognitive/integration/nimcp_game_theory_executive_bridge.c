...
/** Global health agent for game_theory_executive_bridge module */
static nimcp_health_agent_t* g_game_theory_executive_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from game_theory_executive_bridge module */
static inline void game_theory_executive_bridge_heartbeat(const char* operation, float progress) {
