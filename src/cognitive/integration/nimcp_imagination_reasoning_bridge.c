...
/** Global health agent for imagination_reasoning_bridge module */
static nimcp_health_agent_t* g_imagination_reasoning_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from imagination_reasoning_bridge module */
static inline void imagination_reasoning_bridge_heartbeat(const char* operation, float progress) {
