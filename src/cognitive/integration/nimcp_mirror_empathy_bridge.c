...
/** Global health agent for mirror_empathy_bridge module */
static nimcp_health_agent_t* g_mirror_empathy_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from mirror_empathy_bridge module */
static inline void mirror_empathy_bridge_heartbeat(const char* operation, float progress) {
