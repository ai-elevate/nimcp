...
/** Global health agent for predictive_attention_bridge module */
static nimcp_health_agent_t* g_predictive_attention_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from predictive_attention_bridge module */
static inline void predictive_attention_bridge_heartbeat(const char* operation, float progress) {
