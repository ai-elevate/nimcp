...
/** Global health agent for rcog_hub_bridge module */
static nimcp_health_agent_t* g_rcog_hub_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from rcog_hub_bridge module */
static inline void rcog_hub_bridge_heartbeat(const char* operation, float progress) {
