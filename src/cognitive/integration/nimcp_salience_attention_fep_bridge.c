...
/** Global health agent for salience_attention_fep_bridge module */
static nimcp_health_agent_t* g_salience_attention_fep_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from salience_attention_fep_bridge module */
static inline void salience_attention_fep_bridge_heartbeat(const char* operation, float progress) {
