...
/** Global health agent for security_cognitive_hub_bridge module */
static nimcp_health_agent_t* g_security_cognitive_hub_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from security_cognitive_hub_bridge module */
static inline void security_cognitive_hub_bridge_heartbeat(const char* operation, float progress) {
