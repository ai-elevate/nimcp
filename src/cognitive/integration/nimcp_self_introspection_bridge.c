...
/** Global health agent for self_introspection_bridge module */
static nimcp_health_agent_t* g_self_introspection_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from self_introspection_bridge module */
static inline void self_introspection_bridge_heartbeat(const char* operation, float progress) {
