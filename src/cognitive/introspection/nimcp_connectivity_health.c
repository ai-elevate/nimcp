...
/** Global health agent for connectivity_health module */
static nimcp_health_agent_t* g_connectivity_health_health_agent = NULL;
...
/** @brief Send heartbeat from connectivity_health module */
static inline void connectivity_health_heartbeat(const char* operation, float progress) {
