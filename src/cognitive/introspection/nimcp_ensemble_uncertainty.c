...
/** Global health agent for ensemble_uncertainty module */
static nimcp_health_agent_t* g_ensemble_uncertainty_health_agent = NULL;
...
/** @brief Send heartbeat from ensemble_uncertainty module */
static inline void ensemble_uncertainty_heartbeat(const char* operation, float progress) {
