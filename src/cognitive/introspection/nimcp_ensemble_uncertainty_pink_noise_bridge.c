...
/** Global health agent for ensemble_uncertainty_pink_noise_bridge module */
static nimcp_health_agent_t* g_ensemble_uncertainty_pink_noise_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from ensemble_uncertainty_pink_noise_bridge module */
static inline void ensemble_uncertainty_pink_noise_bridge_heartbeat(const char* operation, float progress) {
