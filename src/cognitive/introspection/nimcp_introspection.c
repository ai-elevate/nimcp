...
/** Global health agent for introspection module */
static nimcp_health_agent_t* g_introspection_health_agent = NULL;
...
/** @brief Send heartbeat from introspection module */
static inline void introspection_heartbeat(const char* operation, float progress) {
