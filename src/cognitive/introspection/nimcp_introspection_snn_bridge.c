...
/** Global health agent for introspection_snn_bridge module */
static nimcp_health_agent_t* g_introspection_snn_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from introspection_snn_bridge module */
static inline void introspection_snn_bridge_heartbeat(const char* operation, float progress) {
