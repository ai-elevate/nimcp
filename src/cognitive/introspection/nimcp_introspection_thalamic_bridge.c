...
/** Global health agent for introspection_thalamic_bridge module */
static nimcp_health_agent_t* g_introspection_thalamic_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from introspection_thalamic_bridge module */
static inline void introspection_thalamic_bridge_heartbeat(const char* operation, float progress) {
