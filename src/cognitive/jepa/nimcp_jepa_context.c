...
/** Global health agent for jepa_context module */
static nimcp_health_agent_t* g_jepa_context_health_agent = NULL;
...
/** @brief Send heartbeat from jepa_context module */
static inline void jepa_context_heartbeat(const char* operation, float progress) {
