...
/** Global health agent for jepa_latent module */
static nimcp_health_agent_t* g_jepa_latent_health_agent = NULL;
...
/** @brief Send heartbeat from jepa_latent module */
static inline void jepa_latent_heartbeat(const char* operation, float progress) {
