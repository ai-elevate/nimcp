...
/** Global health agent for jepa_multimodal module */
static nimcp_health_agent_t* g_jepa_multimodal_health_agent = NULL;
...
/** @brief Send heartbeat from jepa_multimodal module */
static inline void jepa_multimodal_heartbeat(const char* operation, float progress) {
