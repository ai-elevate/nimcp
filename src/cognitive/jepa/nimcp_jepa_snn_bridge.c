...
/** Global health agent for jepa_snn_bridge module */
static nimcp_health_agent_t* g_jepa_snn_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from jepa_snn_bridge module */
static inline void jepa_snn_bridge_heartbeat(const char* operation, float progress) {
