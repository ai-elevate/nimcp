...
/** Global health agent for jepa_substrate_bridge module */
static nimcp_health_agent_t* g_jepa_substrate_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from jepa_substrate_bridge module */
static inline void jepa_substrate_bridge_heartbeat(const char* operation, float progress) {
