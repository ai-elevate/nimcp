...
/** Global health agent for joy_euphoria module */
static nimcp_health_agent_t* g_joy_euphoria_health_agent = NULL;
...
/** @brief Send heartbeat from joy_euphoria module */
static inline void joy_euphoria_heartbeat(const char* operation, float progress) {
