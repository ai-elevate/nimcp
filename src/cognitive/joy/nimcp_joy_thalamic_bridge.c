...
/** Global health agent for joy_thalamic_bridge module */
static nimcp_health_agent_t* g_joy_thalamic_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from joy_thalamic_bridge module */
static inline void joy_thalamic_bridge_heartbeat(const char* operation, float progress) {
