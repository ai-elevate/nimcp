...
/** Global health agent for knowledge module */
static nimcp_health_agent_t* g_knowledge_health_agent = NULL;
...
/** @brief Send heartbeat from knowledge module */
static inline void knowledge_heartbeat(const char* operation, float progress) {
