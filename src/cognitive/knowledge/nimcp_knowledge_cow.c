...
/** Global health agent for knowledge_cow module */
static nimcp_health_agent_t* g_knowledge_cow_health_agent = NULL;
...
/** @brief Send heartbeat from knowledge_cow module */
static inline void knowledge_cow_heartbeat(const char* operation, float progress) {
