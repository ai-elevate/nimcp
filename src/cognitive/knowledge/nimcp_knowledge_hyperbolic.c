...
/** Global health agent for knowledge_hyperbolic module */
static nimcp_health_agent_t* g_knowledge_hyperbolic_health_agent = NULL;
...
/** @brief Send heartbeat from knowledge_hyperbolic module */
static inline void knowledge_hyperbolic_heartbeat(const char* operation, float progress) {
