...
/** Global health agent for knowledge_snn_bridge module */
static nimcp_health_agent_t* g_knowledge_snn_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from knowledge_snn_bridge module */
static inline void knowledge_snn_bridge_heartbeat(const char* operation, float progress) {
