...
/** Global health agent for visual_logic_bridge module */
static nimcp_health_agent_t* g_visual_logic_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from visual_logic_bridge module */
static inline void visual_logic_bridge_heartbeat(const char* operation, float progress) {
