...
/** Global health agent for llf_substrate_bridge module */
static nimcp_health_agent_t* g_llf_substrate_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from llf_substrate_bridge module */
static inline void llf_substrate_bridge_heartbeat(const char* operation, float progress) {
