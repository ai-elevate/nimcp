...
/** Global health agent for love_loyalty_friendship_fep_bridge module */
static nimcp_health_agent_t* g_love_loyalty_friendship_fep_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from love_loyalty_friendship_fep_bridge module */
static inline void love_loyalty_friendship_fep_bridge_heartbeat(const char* operation, float progress) {
