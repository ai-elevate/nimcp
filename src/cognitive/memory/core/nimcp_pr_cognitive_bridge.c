...
/** Global health agent for pr_cognitive_bridge module */
static nimcp_health_agent_t* g_pr_cognitive_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from pr_cognitive_bridge module */
