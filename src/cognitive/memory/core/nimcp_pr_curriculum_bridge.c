...
/** Global health agent for pr_curriculum_bridge module */
static nimcp_health_agent_t* g_pr_curriculum_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from pr_curriculum_bridge module */
