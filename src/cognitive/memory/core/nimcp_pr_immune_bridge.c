...
/** Global health agent for pr_immune_bridge module */
static nimcp_health_agent_t* g_pr_immune_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from pr_immune_bridge module */
