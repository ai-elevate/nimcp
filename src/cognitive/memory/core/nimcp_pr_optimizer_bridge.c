...
/** Global health agent for pr_optimizer_bridge module */
static nimcp_health_agent_t* g_pr_optimizer_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from pr_optimizer_bridge module */
static inline void pr_optimizer_bridge_heartbeat(const char* operation, float progress) {
