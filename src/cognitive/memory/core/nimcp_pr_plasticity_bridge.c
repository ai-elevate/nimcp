...
/** Global health agent for pr_plasticity_bridge module */
static nimcp_health_agent_t* g_pr_plasticity_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from pr_plasticity_bridge module */
