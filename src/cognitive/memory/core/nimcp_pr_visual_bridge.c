...
/** Global health agent for pr_visual_bridge module */
static nimcp_health_agent_t* g_pr_visual_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from pr_visual_bridge module */
static inline void pr_visual_bridge_heartbeat(const char* operation, float progress) {
