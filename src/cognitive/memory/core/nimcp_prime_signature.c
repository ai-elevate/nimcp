...
/** Global health agent for prime_signature module */
static nimcp_health_agent_t* g_prime_signature_health_agent = NULL;
...
/** @brief Send heartbeat from prime_signature module */
static inline void prime_signature_heartbeat(const char* operation, float progress) {
