...
/** Global health agent for quaternion module */
static nimcp_health_agent_t* g_quaternion_health_agent = NULL;
...
/** @brief Send heartbeat from quaternion module */
static inline void quaternion_heartbeat(const char* operation, float progress) {
