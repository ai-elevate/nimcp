...
/** Global health agent for resonance module */
static nimcp_health_agent_t* g_resonance_health_agent = NULL;
...
/** @brief Send heartbeat from resonance module */
static inline void resonance_heartbeat(const char* operation, float progress) {
    ...
    resonance_batch_result_t* results)
{
    ...
    resonance_batch_result_t* all_results =
        (resonance_batch_result_t*)malloc(count * sizeof(resonance_batch_result_t));
    if (!all_results) {
