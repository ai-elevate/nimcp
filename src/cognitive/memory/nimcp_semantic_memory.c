...
/** Global health agent for semantic_memory module */
static nimcp_health_agent_t* g_semantic_memory_health_agent = NULL;
...
/** @brief Send heartbeat from semantic_memory module */
static inline void semantic_memory_heartbeat(const char* operation, float progress) {
