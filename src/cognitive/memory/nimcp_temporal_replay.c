...
/** Global health agent for temporal_replay module */
static nimcp_health_agent_t* g_temporal_replay_health_agent = NULL;
...
/** @brief Send heartbeat from temporal_replay module */
static inline void temporal_replay_heartbeat(const char* operation, float progress) {
