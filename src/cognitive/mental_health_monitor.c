...
/** Global health agent for mental_health_monitor module */
static nimcp_health_agent_t* g_mental_health_monitor_health_agent = NULL;
...
/** @brief Send heartbeat from mental_health_monitor module */
static inline void mental_health_monitor_heartbeat(const char* operation, float progress) {
