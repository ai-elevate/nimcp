...
/** Global health agent for meta_learning_plasticity_bridge module */
static nimcp_health_agent_t* g_meta_learning_plasticity_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from meta_learning_plasticity_bridge module */
static inline void meta_learning_plasticity_bridge_heartbeat(const char* operation, float progress) {
