...
/** Global health agent for meta_learning_substrate_bridge module */
static nimcp_health_agent_t* g_meta_learning_substrate_bridge_health_agent = NULL;

/**
 * @brief Set health agent for meta_learning_substrate_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
void meta_learning_substrate_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_meta_learning_substrate_bridge_health_agent = agent;
}

/** @brief Send heartbeat from meta_learning_substrate_bridge module */
static inline void meta_learning_substrate_bridge_heartbeat(const char* operation, float progress) {
