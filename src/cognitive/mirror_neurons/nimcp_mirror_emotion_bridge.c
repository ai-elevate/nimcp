...
/** Global health agent for mirror_emotion_bridge module */
static nimcp_health_agent_t* g_mirror_emotion_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from mirror_emotion_bridge module */
static inline void mirror_emotion_bridge_heartbeat(const char* operation, float progress) {
