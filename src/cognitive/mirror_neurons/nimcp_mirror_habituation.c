...
/** Global health agent for mirror_habituation module */
static nimcp_health_agent_t* g_mirror_habituation_health_agent = NULL;
...
/** @brief Send heartbeat from mirror_habituation module */
static inline void mirror_habituation_heartbeat(const char* operation, float progress) {
