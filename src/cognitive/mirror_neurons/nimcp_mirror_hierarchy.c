...
/** Global health agent for mirror_hierarchy module */
static nimcp_health_agent_t* g_mirror_hierarchy_health_agent = NULL;
...
/** @brief Send heartbeat from mirror_hierarchy module */
static inline void mirror_hierarchy_heartbeat(const char* operation, float progress) {
