...
/** Global health agent for mirror_hippocampus_bridge module */
static nimcp_health_agent_t* g_mirror_hippocampus_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from mirror_hippocampus_bridge module */
static inline void mirror_hippocampus_bridge_heartbeat(const char* operation, float progress) {
