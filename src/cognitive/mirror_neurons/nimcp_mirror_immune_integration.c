...
/** Global health agent for mirror_immune_integration module */
static nimcp_health_agent_t* g_mirror_immune_integration_health_agent = NULL;
...
/** @brief Send heartbeat from mirror_immune_integration module */
static inline void mirror_immune_integration_heartbeat(const char* operation, float progress) {
