...
/** Global health agent for mirror_multimodal module */
static nimcp_health_agent_t* g_mirror_multimodal_health_agent = NULL;
...
/** @brief Send heartbeat from mirror_multimodal module */
static inline void mirror_multimodal_heartbeat(const char* operation, float progress) {
