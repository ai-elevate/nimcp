...
/** Global health agent for mirror_resonance module */
static nimcp_health_agent_t* g_mirror_resonance_health_agent = NULL;
...
/** @brief Send heartbeat from mirror_resonance module */
static inline void mirror_resonance_heartbeat(const char* operation, float progress) {
