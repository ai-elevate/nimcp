...
/** Global health agent for mirror_snn_bridge module */
static nimcp_health_agent_t* g_mirror_snn_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from mirror_snn_bridge module */
static inline void mirror_snn_bridge_heartbeat(const char* operation, float progress) {
