...
/** Global health agent for mirror_social_context module */
static nimcp_health_agent_t* g_mirror_social_context_health_agent = NULL;
...
/** @brief Send heartbeat from mirror_social_context module */
static inline void mirror_social_context_heartbeat(const char* operation, float progress) {
