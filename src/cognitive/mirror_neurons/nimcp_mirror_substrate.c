...
/** Global health agent for mirror_substrate module */
static nimcp_health_agent_t* g_mirror_substrate_health_agent = NULL;
...
/** @brief Send heartbeat from mirror_substrate module */
static inline void mirror_substrate_heartbeat(const char* operation, float progress) {
