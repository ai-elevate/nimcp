...
/** Global health agent for mirror_vicarious_reward module */
static nimcp_health_agent_t* g_mirror_vicarious_reward_health_agent = NULL;
...
/** @brief Send heartbeat from mirror_vicarious_reward module */
static inline void mirror_vicarious_reward_heartbeat(const char* operation, float progress) {
