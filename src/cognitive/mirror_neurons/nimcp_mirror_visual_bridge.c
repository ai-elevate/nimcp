...
/** Global health agent for mirror_visual_bridge module */
static nimcp_health_agent_t* g_mirror_visual_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from mirror_visual_bridge module */
static inline void mirror_visual_bridge_heartbeat(const char* operation, float progress) {
