...
/** Global health agent for genius_game_theory_bridge module */
static nimcp_health_agent_t* g_genius_game_theory_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from genius_game_theory_bridge module */
static inline void genius_game_theory_bridge_heartbeat(const char* operation, float progress) {
