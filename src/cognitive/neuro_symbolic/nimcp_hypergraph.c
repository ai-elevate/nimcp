...
BRIDGE_BOILERPLATE(hypergraph, MESH_ADAPTER_CATEGORY_COGNITIVE)
...
//=============================================================================
#include "nimcp_hypergraph_part_helpers.c"  // 9 functions: helpers
#include "nimcp_hypergraph_part_core.c"  // 2 functions: core
