...
/** Global health agent for quantum_mcts module */
static nimcp_health_agent_t* g_quantum_mcts_health_agent = NULL;
...
/** @brief Send heartbeat from quantum_mcts module */
static inline void quantum_mcts_heartbeat(const char* operation, float progress) {
