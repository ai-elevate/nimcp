...
/** Global health agent for cognitive_meta_controller module */
static nimcp_health_agent_t* g_cognitive_meta_controller_health_agent = NULL;
...
/** @brief Send heartbeat from cognitive_meta_controller module */
static inline void cognitive_meta_controller_heartbeat(const char* operation, float progress) {
