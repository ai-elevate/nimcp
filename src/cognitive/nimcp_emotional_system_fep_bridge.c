...
/** Global health agent for emotional_system_fep_bridge module */
static nimcp_health_agent_t* g_emotional_system_fep_bridge_health_agent = NULL;

/**
 * @brief Set health agent for emotional_system_fep_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void emotional_system_fep_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_emotional_system_fep_bridge_health_agent = agent;
}

/** @brief Send heartbeat from emotional_system_fep_bridge module */
static inline void emotional_system_fep_bridge_heartbeat(const char* operation, float progress) {
