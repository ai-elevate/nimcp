...
/** Global health agent for fractal_cognitive module */
static nimcp_health_agent_t* g_fractal_cognitive_health_agent = NULL;
...
/** @brief Send heartbeat from fractal_cognitive module */
static inline void fractal_cognitive_heartbeat(const char* operation, float progress) {
