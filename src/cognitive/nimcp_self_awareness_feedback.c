...
/** Global health agent for self_awareness_feedback module */
static nimcp_health_agent_t* g_self_awareness_feedback_health_agent = NULL;
...
/** @brief Send heartbeat from self_awareness_feedback module */
static inline void self_awareness_feedback_heartbeat(const char* operation, float progress) {
