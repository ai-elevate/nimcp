...
/** Global health agent for omni_wm_kg_bridge module */
static nimcp_health_agent_t* g_omni_wm_kg_bridge_health_agent = NULL;

/**
 * @brief Set health agent for omni_wm_kg_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void omni_wm_kg_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_omni_wm_kg_bridge_health_agent = agent;
}

/** @brief Send heartbeat from omni_wm_kg_bridge module */
static inline void omni_wm_kg_bridge_heartbeat(const char* operation, float progress) {
