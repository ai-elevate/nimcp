...
/** Global health agent for omni_wm_security_immune_bridge module */
static nimcp_health_agent_t* g_omni_wm_security_immune_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from omni_wm_security_immune_bridge module */
static inline void omni_wm_security_immune_bridge_heartbeat(const char* operation, float progress) {
