...
/** Global health agent for omni_kg_sync module */
static nimcp_health_agent_t* g_omni_kg_sync_health_agent = NULL;
...
/** @brief Send heartbeat from omni_kg_sync module */
static inline void omni_kg_sync_heartbeat(const char* operation, float progress) {
