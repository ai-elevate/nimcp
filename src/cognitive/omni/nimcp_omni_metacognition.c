...
/** Global health agent for omni_metacognition module */
static nimcp_health_agent_t* g_omni_metacognition_health_agent = NULL;
...
/** @brief Send heartbeat from omni_metacognition module */
static inline void omni_metacognition_heartbeat(const char* operation, float progress) {
