...
/** Global health agent for omni_precision module */
static nimcp_health_agent_t* g_omni_precision_health_agent = NULL;
...
/** @brief Send heartbeat from omni_precision module */
static inline void omni_precision_heartbeat(const char* operation, float progress) {
