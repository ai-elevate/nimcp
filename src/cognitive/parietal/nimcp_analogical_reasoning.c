...
/** Global health agent for analogical_reasoning module */
static nimcp_health_agent_t* g_analogical_reasoning_health_agent = NULL;
...
/** @brief Send heartbeat from analogical_reasoning module */
static inline void analogical_reasoning_heartbeat(const char* operation, float progress) {
