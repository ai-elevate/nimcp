...
/** Global health agent for conceptual_blending module */
static nimcp_health_agent_t* g_conceptual_blending_health_agent = NULL;
...
/** @brief Send heartbeat from conceptual_blending module */
static inline void conceptual_blending_heartbeat(const char* operation, float progress) {
