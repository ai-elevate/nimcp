...
BRIDGE_DEFINE_MESH_REGISTRATION(fin_consolidation, MESH_ADAPTER_CATEGORY_COGNITIVE)
...
static _Thread_local char fin_consolidation_last_error[NIMCP_ERROR_BUFFER_SIZE] = {0};
