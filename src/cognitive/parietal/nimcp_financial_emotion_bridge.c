...
/** Global health agent for financial_emotion_bridge module */
static nimcp_health_agent_t* g_financial_emotion_bridge_health_agent = NULL;

/**
 * @brief Set health agent for financial_emotion_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
void financial_emotion_bridge_set_health_agent_global(nimcp_health_agent_t* agent) {
    g_financial_emotion_bridge_health_agent = agent;
}
