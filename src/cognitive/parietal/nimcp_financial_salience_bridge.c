...
BRIDGE_DEFINE_MESH_REGISTRATION(financial_salience_bridge, MESH_ADAPTER_CATEGORY_COGNITIVE)
...
static _Thread_local char fin_salience_last_error[NIMCP_ERROR_BUFFER_SIZE] = {0};
