...
/** Global health agent for genius_plasticity_bridge module */
static nimcp_health_agent_t* g_genius_plasticity_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from genius_plasticity_bridge module */
static inline void genius_plasticity_bridge_heartbeat(const char* operation, float progress) {
