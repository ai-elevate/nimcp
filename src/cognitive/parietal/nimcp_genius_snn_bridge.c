...
/** Global health agent for genius_snn_bridge module */
static nimcp_health_agent_t* g_genius_snn_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from genius_snn_bridge module */
static inline void genius_snn_bridge_heartbeat(const char* operation, float progress) {
