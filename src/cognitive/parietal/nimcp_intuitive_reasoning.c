...
/** Global health agent for intuitive_reasoning module */
static nimcp_health_agent_t* g_intuitive_reasoning_health_agent = NULL;
...
/** @brief Send heartbeat from intuitive_reasoning module */
