...
/** Global health agent for meta_reasoning module */
static nimcp_health_agent_t* g_meta_reasoning_health_agent = NULL;
...
/** @brief Send heartbeat from meta_reasoning module */
