...
/** Global health agent for parietal_fep_bridge module */
static nimcp_health_agent_t* g_parietal_fep_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from parietal_fep_bridge module */
static inline void parietal_fep_bridge_heartbeat(const char* operation, float progress) {
