...
/** Global health agent for parietal_plasticity_bridge module */
static nimcp_health_agent_t* g_parietal_plasticity_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from parietal_plasticity_bridge module */
static inline void parietal_plasticity_bridge_heartbeat(const char* operation, float progress) {
