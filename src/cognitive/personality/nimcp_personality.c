...
/** Global health agent for personality module */
static nimcp_health_agent_t* g_personality_health_agent = NULL;
...
/** @brief Send heartbeat from personality module */
static inline void personality_heartbeat(const char* operation, float progress) {
