...
/** Global health agent for personality_substrate_bridge module */
static nimcp_health_agent_t* g_personality_substrate_bridge_health_agent = NULL;

/**
 * @brief Set health agent for personality_substrate_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
void personality_substrate_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_personality_substrate_bridge_health_agent = agent;
}

/** @brief Send heartbeat from personality_substrate_bridge module */
static inline void personality_substrate_bridge_heartbeat(const char* operation, float progress) {
