...
/** Global health agent for predictive module */
static nimcp_health_agent_t* g_predictive_health_agent = NULL;
...
/** @brief Send heartbeat from predictive module */
static inline void predictive_heartbeat(const char* operation, float progress) {
