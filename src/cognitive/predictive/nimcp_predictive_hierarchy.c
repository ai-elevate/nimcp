...
/** Global health agent for predictive_hierarchy module */
static nimcp_health_agent_t* g_predictive_hierarchy_health_agent = NULL;
...
/** @brief Send heartbeat from predictive_hierarchy module */
static inline void predictive_hierarchy_heartbeat(const char* operation, float progress) {
