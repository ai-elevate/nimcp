...
/** Global health agent for predictive_plasticity_bridge module */
static nimcp_health_agent_t* g_predictive_plasticity_bridge_health_agent = NULL;

/**
 * @brief Set health agent for predictive_plasticity_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
void predictive_plasticity_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_predictive_plasticity_bridge_health_agent = agent;
}

/** @brief Send heartbeat from predictive_plasticity_bridge module */
