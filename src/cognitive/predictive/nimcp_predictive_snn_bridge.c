...
/** Global health agent for predictive_snn_bridge module */
static nimcp_health_agent_t* g_predictive_snn_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from predictive_snn_bridge module */
