...
/** Global health agent for predictive_immune module */
static nimcp_health_agent_t* g_predictive_immune_health_agent = NULL;
...
/** @brief Send heartbeat from predictive_immune module */
static inline void predictive_immune_heartbeat(const char* operation, float progress) {
