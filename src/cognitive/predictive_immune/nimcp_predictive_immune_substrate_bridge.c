...
/** Global health agent for predictive_immune_substrate_bridge module */
static nimcp_health_agent_t* g_predictive_immune_substrate_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from predictive_immune_substrate_bridge module */
static inline void predictive_immune_substrate_bridge_heartbeat(const char* operation, float progress) {
