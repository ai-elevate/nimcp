...
/** Global health agent for reasoning_attention module */
static nimcp_health_agent_t* g_reasoning_attention_health_agent = NULL;
...
/** @brief Send heartbeat from reasoning_attention module */
static inline void reasoning_attention_heartbeat(const char* operation, float progress) {
