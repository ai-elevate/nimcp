...
/** Global health agent for reasoning_curiosity module */
static nimcp_health_agent_t* g_reasoning_curiosity_health_agent = NULL;
...
/** @brief Send heartbeat from reasoning_curiosity module */
static inline void reasoning_curiosity_heartbeat(const char* operation, float progress) {
