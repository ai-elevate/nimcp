...
/** Global health agent for knowledge_base_interface module */
static nimcp_health_agent_t* g_knowledge_base_interface_health_agent = NULL;

/**
 * @brief Set health agent for knowledge_base_interface heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void knowledge_base_interface_set_health_agent(nimcp_health_agent_t* agent) {
    g_knowledge_base_interface_health_agent = agent;
}

/** @brief Send heartbeat from knowledge_base_interface module */
static inline void knowledge_base_interface_heartbeat(const char* operation, float progress) {
