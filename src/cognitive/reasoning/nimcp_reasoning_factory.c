...
/** Global health agent for reasoning_factory module */
static nimcp_health_agent_t* g_reasoning_factory_health_agent = NULL;
...
/** @brief Send heartbeat from reasoning_factory module */
static inline void reasoning_factory_heartbeat(const char* operation, float progress) {
