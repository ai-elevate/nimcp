...
/** Global health agent for reasoning_fep_bridge module */
static nimcp_health_agent_t* g_reasoning_fep_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from reasoning_fep_bridge module */
static inline void reasoning_fep_bridge_heartbeat(const char* operation, float progress) {
