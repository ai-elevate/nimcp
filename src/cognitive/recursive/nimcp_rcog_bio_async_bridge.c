...
/** Global health agent for rcog_bio_async_bridge module */
static nimcp_health_agent_t* g_rcog_bio_async_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from rcog_bio_async_bridge module */
static inline void rcog_bio_async_bridge_heartbeat(const char* operation, float progress) {
