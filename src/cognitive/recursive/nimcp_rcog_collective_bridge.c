...
/** Global health agent for rcog_collective_bridge module */
static nimcp_health_agent_t* g_rcog_collective_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from rcog_collective_bridge module */
static inline void rcog_collective_bridge_heartbeat(const char* operation, float progress) {
