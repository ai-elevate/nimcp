...
/** Global health agent for rcog_context_store module */
static nimcp_health_agent_t* g_rcog_context_store_health_agent = NULL;
...
/** @brief Send heartbeat from rcog_context_store module */
static inline void rcog_context_store_heartbeat(const char* operation, float progress) {
