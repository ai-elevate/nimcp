...
/** Global health agent for rcog_engine module */
static nimcp_health_agent_t* g_rcog_engine_health_agent = NULL;
...
/** @brief Send heartbeat from rcog_engine module */
static inline void rcog_engine_heartbeat(const char* operation, float progress) {
