...
/** Global health agent for rcog_fep_bridge module */
static nimcp_health_agent_t* g_rcog_fep_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from rcog_fep_bridge module */
static inline void rcog_fep_bridge_heartbeat(const char* operation, float progress) {
