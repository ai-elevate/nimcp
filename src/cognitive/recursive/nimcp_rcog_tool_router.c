...
/** Global health agent for rcog_tool_router module */
static nimcp_health_agent_t* g_rcog_tool_router_health_agent = NULL;
...
/** @brief Send heartbeat from rcog_tool_router module */
static inline void rcog_tool_router_heartbeat(const char* operation, float progress) {
