...
/** Global health agent for remorse_fep_bridge module */
static nimcp_health_agent_t* g_remorse_fep_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from remorse_fep_bridge module */
static inline void remorse_fep_bridge_heartbeat(const char* operation, float progress) {
