...
/** Global health agent for salience_substrate_bridge module */
static nimcp_health_agent_t* g_salience_substrate_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from salience_substrate_bridge module */
static inline void salience_substrate_bridge_heartbeat(const char* operation, float progress) {
