...
/** Global health agent for self_awareness_extended module */
static nimcp_health_agent_t* g_self_awareness_extended_health_agent = NULL;

/**
 * @brief Set health agent for self_awareness_extended heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void self_awareness_extended_set_health_agent(nimcp_health_agent_t* agent) {
    g_self_awareness_extended_health_agent = agent;
}

/** @brief Send heartbeat from self_awareness_extended module */
static inline void self_awareness_extended_heartbeat(const char* operation, float progress) {
