...
/** Global health agent for self_awareness_plasticity_bridge module */
static nimcp_health_agent_t* g_self_awareness_plasticity_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from self_awareness_plasticity_bridge module */
