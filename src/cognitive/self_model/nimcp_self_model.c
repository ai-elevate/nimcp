...
/** Global health agent for self_model module */
static nimcp_health_agent_t* g_self_model_health_agent = NULL;
...
/** @brief Send heartbeat from self_model module */
static inline void self_model_heartbeat(const char* operation, float progress) {
