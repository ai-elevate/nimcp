...
/** Global health agent for self_model_plasticity_bridge module */
static nimcp_health_agent_t* g_self_model_plasticity_bridge_health_agent = NULL;

/**
 * @brief Set health agent for self_model_plasticity_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void self_model_plasticity_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_self_model_plasticity_bridge_health_agent = agent;
}

/** @brief Send heartbeat from self_model_plasticity_bridge module */
static inline void self_model_plasticity_bridge_heartbeat(const char* operation, float progress) {
