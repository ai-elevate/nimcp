...
/** Global health agent for self_model_sleep_bridge module */
static nimcp_health_agent_t* g_self_model_sleep_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from self_model_sleep_bridge module */
static inline void self_model_sleep_bridge_heartbeat(const char* operation, float progress) {
