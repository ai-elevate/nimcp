...
/** Global health agent for shadow_emotions module */
static nimcp_health_agent_t* g_shadow_emotions_health_agent = NULL;

/**
 * @brief Set health agent for shadow_emotions heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void shadow_emotions_set_health_agent(nimcp_health_agent_t* agent) {
    g_shadow_emotions_health_agent = agent;
}

/** @brief Send heartbeat from shadow_emotions module */
static inline void shadow_emotions_heartbeat(const char* operation, float progress) {
