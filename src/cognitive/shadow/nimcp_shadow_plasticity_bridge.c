...
BRIDGE_BOILERPLATE(shadow_plasticity_bridge, MESH_ADAPTER_CATEGORY_COGNITIVE)
...
shadow_plasticity_bridge_t* shadow_plasticity_create(
    ...
    bridge->integration_state.suppression_sensitivity = NIMCP_SENSITIVITY_DEFAULT;
    bridge->integration_state.defense_calibration = 0.5f;
    bridge->integration_state.integration_sensitivity = NIMCP_SENSITIVITY_DEFAULT;
