...
/** Global health agent for shadow_snn_bridge module */
static nimcp_health_agent_t* g_shadow_snn_bridge_health_agent = NULL;

/**
 * @brief Set health agent for shadow_snn_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void shadow_snn_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_shadow_snn_bridge_health_agent = agent;
}

/** @brief Send heartbeat from shadow_snn_bridge module */
static inline void shadow_snn_bridge_heartbeat(const char* operation, float progress) {
