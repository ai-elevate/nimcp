...
/** Global health agent for shadow_emotions_fep_bridge module */
static nimcp_health_agent_t* g_shadow_emotions_fep_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from shadow_emotions_fep_bridge module */
static inline void shadow_emotions_fep_bridge_heartbeat(const char* operation, float progress) {
