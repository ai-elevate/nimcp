...
/** Global health agent for shadow_emotions_substrate_bridge module */
static nimcp_health_agent_t* g_shadow_emotions_substrate_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from shadow_emotions_substrate_bridge module */
