...
/** Global health agent for sleep_wake_snn_bridge module */
static nimcp_health_agent_t* g_sleep_wake_snn_bridge_health_agent = NULL;

/**
 * @brief Set health agent for sleep_wake_snn_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void sleep_wake_snn_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_sleep_wake_snn_bridge_health_agent = agent;
}

/** @brief Send heartbeat from sleep_wake_snn_bridge module */
static inline void sleep_wake_snn_bridge_heartbeat(const char* operation, float progress) {
