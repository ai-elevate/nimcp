...
/** Global health agent for symbolic_logic_substrate_bridge module */
static nimcp_health_agent_t* g_symbolic_logic_substrate_bridge_health_agent = NULL;

/**
 * @brief Set health agent for symbolic_logic_substrate_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
void symbolic_logic_substrate_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_symbolic_logic_substrate_bridge_health_agent = agent;
}

/** @brief Send heartbeat from symbolic_logic_substrate_bridge module */
static inline void symbolic_logic_substrate_bridge_heartbeat(const char* operation, float progress) {
