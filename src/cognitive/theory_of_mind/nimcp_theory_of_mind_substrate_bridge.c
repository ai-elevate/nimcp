...
int theory_of_mind_substrate_bridge_training_begin(void* instance) {
    ...
    theory_of_mind_substrate_bridge_heartbeat("theory_of_mind_substrate_bridge_training_begin", 0.0f);
    return 0;
}
...
int theory_of_mind_substrate_bridge_training_end(void* instance) {
    ...
    theory_of_mind_substrate_bridge_heartbeat("theory_of_mind_substrate_bridge_training_end", 1.0f);
    return 0;
}
...
int theory_of_mind_substrate_bridge_training_step(void* instance, float progress) {
    ...
    theory_of_mind_substrate_bridge_heartbeat("theory_of_mind_substrate_bridge_training_step", progress);
    return 0;
}
