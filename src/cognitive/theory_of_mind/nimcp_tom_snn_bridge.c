...
/** Global health agent for tom_snn_bridge module */
static nimcp_health_agent_t* g_tom_snn_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from tom_snn_bridge module */
static inline void tom_snn_bridge_heartbeat(const char* operation, float progress) {
