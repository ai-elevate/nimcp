...
static nimcp_health_agent_t* g_vae_latent_health_agent = NULL;

static inline void vae_latent_heartbeat(const char* operation, float progress) {
    if (g_vae_latent_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_vae_latent_health_agent, operation, progress);
    }
}
