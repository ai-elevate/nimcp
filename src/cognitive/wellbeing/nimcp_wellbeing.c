...
/** Global health agent for wellbeing module */
static nimcp_health_agent_t* g_wellbeing_health_agent = NULL;
...
/** @brief Send heartbeat from wellbeing module */
static inline void wellbeing_heartbeat(const char* operation, float progress) {
