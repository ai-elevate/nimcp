...
/** Global health agent for wellbeing_eudaimonic module */
static nimcp_health_agent_t* g_wellbeing_eudaimonic_health_agent = NULL;
...
/** @brief Send heartbeat from wellbeing_eudaimonic module */
static inline void wellbeing_eudaimonic_heartbeat(const char* operation, float progress) {
