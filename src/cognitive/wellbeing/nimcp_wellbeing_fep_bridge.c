...
/** Global health agent for wellbeing_fep_bridge module */
static nimcp_health_agent_t* g_wellbeing_fep_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from wellbeing_fep_bridge module */
static inline void wellbeing_fep_bridge_heartbeat(const char* operation, float progress) {
