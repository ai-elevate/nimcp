...
/** Global health agent for wellbeing_homeostasis module */
static nimcp_health_agent_t* g_wellbeing_homeostasis_health_agent = NULL;
...
/** @brief Send heartbeat from wellbeing_homeostasis module */
static inline void wellbeing_homeostasis_heartbeat(const char* operation, float progress) {
