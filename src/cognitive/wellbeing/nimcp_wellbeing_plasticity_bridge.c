...
/** Global health agent for wellbeing_plasticity_bridge module */
static nimcp_health_agent_t* g_wellbeing_plasticity_bridge_health_agent = NULL;

/**
 * @brief Set health agent for wellbeing_plasticity_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void wellbeing_plasticity_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_wellbeing_plasticity_bridge_health_agent = agent;
}

/** @brief Send heartbeat from wellbeing_plasticity_bridge module */
static inline void wellbeing_plasticity_bridge_heartbeat(const char* operation, float progress) {
