...
/** Global health agent for wellbeing_sleep_bridge module */
static nimcp_health_agent_t* g_wellbeing_sleep_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from wellbeing_sleep_bridge module */
static inline void wellbeing_sleep_bridge_heartbeat(const char* operation, float progress) {
