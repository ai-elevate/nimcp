...
/** Global health agent for wellbeing_substrate_bridge module */
static nimcp_health_agent_t* g_wellbeing_substrate_bridge_health_agent = NULL;
...
/** @brief Send heartbeat from wellbeing_substrate_bridge module */
static inline void wellbeing_substrate_bridge_heartbeat(const char* operation, float progress) {
