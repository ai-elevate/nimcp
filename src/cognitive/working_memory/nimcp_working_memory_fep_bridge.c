...
/** Global health agent for working_memory_fep_bridge module */
static nimcp_health_agent_t* g_working_memory_fep_bridge_health_agent = NULL;

/**
 * @brief Set health agent for working_memory_fep_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void working_memory_fep_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_working_memory_fep_bridge_health_agent = agent;
}

/** @brief Send heartbeat from working_memory_fep_bridge module */
static inline void working_memory_fep_bridge_heartbeat(const char* operation, float progress) {
