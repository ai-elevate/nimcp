...
/** Global health agent for brain_init_mental_health_guardian module */
static nimcp_health_agent_t* g_brain_init_mental_health_guardian_health_agent = NULL;

/**
 * @brief Set health agent for brain_init_mental_health_guardian heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void brain_init_mental_health_guardian_set_health_agent(nimcp_health_agent_t* agent) {
    g_brain_init_mental_health_guardian_health_agent = agent;
}

/** @brief Send heartbeat from brain_init_mental_health_guardian module */
static inline void brain_init_mental_health_guardian_heartbeat(const char* operation, float progress) {
    if (g_brain_init_mental_health_guardian_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_brain_init_mental_health_guardian_health_agent, operation, progress);
    }
}
