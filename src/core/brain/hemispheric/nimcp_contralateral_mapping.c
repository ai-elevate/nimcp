...
/** Global health agent for contralateral_mapping module */
static nimcp_health_agent_t* g_contralateral_mapping_health_agent = NULL;

/**
 * @brief Set health agent for contralateral_mapping heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void contralateral_mapping_set_health_agent(nimcp_health_agent_t* agent) {
    g_contralateral_mapping_health_agent = agent;
}

/** @brief Send heartbeat from contralateral_mapping module */
static inline void contralateral_mapping_heartbeat(const char* operation, float progress) {
    if (g_contralateral_mapping_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_contralateral_mapping_health_agent, operation, progress);
    }
}
