...
/** Global health agent for split_brain_experiments module */
static nimcp_health_agent_t* g_split_brain_experiments_health_agent = NULL;

/**
 * @brief Set health agent for split_brain_experiments heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void split_brain_experiments_set_health_agent(nimcp_health_agent_t* agent) {
    g_split_brain_experiments_health_agent = agent;
}

/** @brief Send heartbeat from split_brain_experiments module */
static inline void split_brain_experiments_heartbeat(const char* operation, float progress) {
    if (g_split_brain_experiments_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_split_brain_experiments_health_agent, operation, progress);
    }
}
