...
/** Global health agent for association_learning module */
static nimcp_health_agent_t* g_association_learning_health_agent = NULL;

/**
 * @brief Set health agent for association_learning heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void association_learning_set_health_agent(nimcp_health_agent_t* agent) {
    g_association_learning_health_agent = agent;
}

/** @brief Send heartbeat from association_learning module */
static inline void association_learning_heartbeat(const char* operation, float progress) {
    if (g_association_learning_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_association_learning_health_agent, operation, progress);
    }
}
