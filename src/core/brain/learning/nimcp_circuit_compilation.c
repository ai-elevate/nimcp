...
/** Global health agent for circuit_compilation module */
static nimcp_health_agent_t* g_circuit_compilation_health_agent = NULL;

/**
 * @brief Set health agent for circuit_compilation heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void circuit_compilation_set_health_agent(nimcp_health_agent_t* agent) {
    g_circuit_compilation_health_agent = agent;
}

/** @brief Send heartbeat from circuit_compilation module */
static inline void circuit_compilation_heartbeat(const char* operation, float progress) {
    if (g_circuit_compilation_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_circuit_compilation_health_agent, operation, progress);
    }
}
