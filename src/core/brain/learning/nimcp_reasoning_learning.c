...
/** Global health agent for reasoning_learning module */
static nimcp_health_agent_t* g_reasoning_learning_health_agent = NULL;

/**
 * @brief Set health agent for reasoning_learning heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void reasoning_learning_set_health_agent(nimcp_health_agent_t* agent) {
    g_reasoning_learning_health_agent = agent;
}

/** @brief Send heartbeat from reasoning_learning module */
static inline void reasoning_learning_heartbeat(const char* operation, float progress) {
    if (g_reasoning_learning_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_reasoning_learning_health_agent, operation, progress);
    }
}
