...
/** Global health agent for phonological module */
static nimcp_health_agent_t* g_phonological_health_agent = NULL;

/**
 * @brief Set health agent for phonological heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void phonological_set_health_agent(nimcp_health_agent_t* agent) {
    g_phonological_health_agent = agent;
}

/** @brief Send heartbeat from phonological module */
static inline void phonological_heartbeat(const char* operation, float progress) {
    if (g_phonological_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_phonological_health_agent, operation, progress);
    }
}
