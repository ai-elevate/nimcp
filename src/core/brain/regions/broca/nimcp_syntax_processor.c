...
/** Global health agent for syntax_processor module */
static nimcp_health_agent_t* g_syntax_processor_health_agent = NULL;

/**
 * @brief Set health agent for syntax_processor heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void syntax_processor_set_health_agent(nimcp_health_agent_t* agent) {
    g_syntax_processor_health_agent = agent;
}

/** @brief Send heartbeat from syntax_processor module */
static inline void syntax_processor_heartbeat(const char* operation, float progress) {
    if (g_syntax_processor_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_syntax_processor_health_agent, operation, progress);
    }
}
