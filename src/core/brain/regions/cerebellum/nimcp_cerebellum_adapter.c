...
/** Global health agent for cerebellum_adapter module */
static nimcp_health_agent_t* g_cerebellum_adapter_health_agent = NULL;

/**
 * @brief Set health agent for cerebellum_adapter heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void cerebellum_adapter_set_health_agent(nimcp_health_agent_t* agent) {
    g_cerebellum_adapter_health_agent = agent;
}

/** @brief Send heartbeat from cerebellum_adapter module */
static inline void cerebellum_adapter_heartbeat(const char* operation, float progress) {
    if (g_cerebellum_adapter_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_cerebellum_adapter_health_agent, operation, progress);
    }
}
