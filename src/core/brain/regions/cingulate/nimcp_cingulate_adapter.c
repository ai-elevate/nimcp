...
/** Global health agent for cingulate_adapter module */
static nimcp_health_agent_t* g_cingulate_adapter_health_agent = NULL;

/**
 * @brief Set health agent for cingulate_adapter heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void cingulate_adapter_set_health_agent(nimcp_health_agent_t* agent) {
    g_cingulate_adapter_health_agent = agent;
}

/** @brief Send heartbeat from cingulate_adapter module */
static inline void cingulate_adapter_heartbeat(const char* operation, float progress) {
    if (g_cingulate_adapter_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_cingulate_adapter_health_agent, operation, progress);
    }
}
