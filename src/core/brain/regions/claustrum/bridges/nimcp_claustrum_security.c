...
/** Global health agent for claustrum_security module */
static nimcp_health_agent_t* g_claustrum_security_health_agent = NULL;

/**
 * @brief Set health agent for claustrum_security heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void claustrum_security_set_health_agent(nimcp_health_agent_t* agent) {
    g_claustrum_security_health_agent = agent;
}

/** @brief Send heartbeat from claustrum_security module */
static inline void claustrum_security_heartbeat(const char* operation, float progress) {
    if (g_claustrum_security_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_claustrum_security_health_agent, operation, progress);
    }
}
