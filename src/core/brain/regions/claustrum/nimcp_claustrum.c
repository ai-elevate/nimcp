...
/** Global health agent for claustrum module */
static nimcp_health_agent_t* g_claustrum_health_agent = NULL;

/**
 * @brief Set health agent for claustrum heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void claustrum_set_health_agent(nimcp_health_agent_t* agent) {
    g_claustrum_health_agent = agent;
}

/** @brief Send heartbeat from claustrum module */
static inline void claustrum_heartbeat(const char* operation, float progress) {
    if (g_claustrum_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_claustrum_health_agent, operation, progress);
    }
}
