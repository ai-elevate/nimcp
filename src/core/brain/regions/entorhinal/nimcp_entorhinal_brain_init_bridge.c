...
/** Global health agent for entorhinal_brain_init_bridge module */
static nimcp_health_agent_t* g_entorhinal_brain_init_bridge_health_agent = NULL;

/**
 * @brief Set health agent for entorhinal_brain_init_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void entorhinal_brain_init_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_entorhinal_brain_init_bridge_health_agent = agent;
}

/** @brief Send heartbeat from entorhinal_brain_init_bridge module */
static inline void entorhinal_brain_init_bridge_heartbeat(const char* operation, float progress) {
    if (g_entorhinal_brain_init_bridge_health_agent) {
