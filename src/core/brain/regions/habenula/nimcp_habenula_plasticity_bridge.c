...
/** Global health agent for habenula_plasticity_bridge module */
static nimcp_health_agent_t* g_habenula_plasticity_bridge_health_agent = NULL;

/**
 * @brief Set health agent for habenula_plasticity_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void habenula_plasticity_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_habenula_plasticity_bridge_health_agent = agent;
}

/** @brief Send heartbeat from habenula_plasticity_bridge module */
static inline void habenula_plasticity_bridge_heartbeat(const char* operation, float progress) {
    if (g_habenula_plasticity_bridge_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_habenula_plasticity_bridge_health_agent, operation, progress);
    }
}
