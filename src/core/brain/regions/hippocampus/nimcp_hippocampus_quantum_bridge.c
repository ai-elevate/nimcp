...
/** Global health agent for hippocampus_quantum_bridge module */
static nimcp_health_agent_t* g_hippocampus_quantum_bridge_health_agent = NULL;

/**
 * @brief Set health agent for hippocampus_quantum_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void hippocampus_quantum_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_hippocampus_quantum_bridge_health_agent = agent;
}

/** @brief Send heartbeat from hippocampus_quantum_bridge module */
static inline void hippocampus_quantum_bridge_heartbeat(const char* operation, float progress) {
    if (g_hippocampus_quantum_bridge_health_agent) {
