...
/** Global health agent for hypothalamus_quantum_bridge module */
static nimcp_health_agent_t* g_hypothalamus_quantum_bridge_health_agent = NULL;

/**
 * @brief Set health agent for hypothalamus_quantum_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void hypothalamus_quantum_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_hypothalamus_quantum_bridge_health_agent = agent;
}

/** @brief Send heartbeat from hypothalamus_quantum_bridge module */
static inline void hypothalamus_quantum_bridge_heartbeat(const char* operation, float progress) {
    if (g_hypothalamus_quantum_bridge_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_hypothalamus_quantum_bridge_health_agent, operation, progress);
    }
}
