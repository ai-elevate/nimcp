...
/** Global health agent for lc_snn_bridge module */
static nimcp_health_agent_t* g_lc_snn_bridge_health_agent = NULL;

/**
 * @brief Set health agent for lc_snn_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void lc_snn_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_lc_snn_bridge_health_agent = agent;
}

/** @brief Send heartbeat from lc_snn_bridge module */
static inline void lc_snn_bridge_heartbeat(const char* operation, float progress) {
    if (g_lc_snn_bridge_health_agent) {
