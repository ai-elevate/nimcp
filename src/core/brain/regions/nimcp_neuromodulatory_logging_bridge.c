...
/** Global health agent for neuromodulatory_logging_bridge module */
static nimcp_health_agent_t* g_neuromodulatory_logging_bridge_health_agent = NULL;

/**
 * @brief Set health agent for neuromodulatory_logging_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void neuromodulatory_logging_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_neuromodulatory_logging_bridge_health_agent = agent;
}

/** @brief Send heartbeat from neuromodulatory_logging_bridge module */
static inline void neuromodulatory_logging_bridge_heartbeat(const char* operation, float progress) {
    if (g_neuromodulatory_logging_bridge_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_neuromodulatory_logging_bridge_health_agent, operation, progress);
    }
}
