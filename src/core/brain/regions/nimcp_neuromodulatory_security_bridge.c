...
/** Global health agent for neuromodulatory_security_bridge module */
static nimcp_health_agent_t* g_neuromodulatory_security_bridge_health_agent = NULL;

/**
 * @brief Set health agent for neuromodulatory_security_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void neuromodulatory_security_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_neuromodulatory_security_bridge_health_agent = agent;
}

/** @brief Send heartbeat from neuromodulatory_security_bridge module */
static inline void neuromodulatory_security_bridge_heartbeat(const char* operation, float progress) {
    if (g_neuromodulatory_security_bridge_health_agent) {
