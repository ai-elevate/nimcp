...
/** Global health agent for occipital_cortical_bridge module */
static nimcp_health_agent_t* g_occipital_cortical_bridge_health_agent = NULL;

/**
 * @brief Set health agent for occipital_cortical_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void occipital_cortical_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_occipital_cortical_bridge_health_agent = agent;
}

/** @brief Send heartbeat from occipital_cortical_bridge module */
static inline void occipital_cortical_bridge_heartbeat(const char* operation, float progress) {
    if (g_occipital_cortical_bridge_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_occipital_cortical_bridge_health_agent, operation, progress);
    }
}
