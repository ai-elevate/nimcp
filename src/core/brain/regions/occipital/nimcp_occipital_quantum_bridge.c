...
/** Global health agent for occipital_quantum_bridge module */
static nimcp_health_agent_t* g_occipital_quantum_bridge_health_agent = NULL;

/**
 * @brief Set health agent for occipital_quantum_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void occipital_quantum_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_occipital_quantum_bridge_health_agent = agent;
}

/** @brief Send heartbeat from occipital_quantum_bridge module */
static inline void occipital_quantum_bridge_heartbeat(const char* operation, float progress) {
    if (g_occipital_quantum_bridge_health_agent) {
