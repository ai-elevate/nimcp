...
/** Global health agent for prefrontal_quantum_bridge module */
static nimcp_health_agent_t* g_prefrontal_quantum_bridge_health_agent = NULL;

/**
 * @brief Set health agent for prefrontal_quantum_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void prefrontal_quantum_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_prefrontal_quantum_bridge_health_agent = agent;
}

/** @brief Send heartbeat from prefrontal_quantum_bridge module */
static inline void prefrontal_quantum_bridge_heartbeat(const char* operation, float progress) {
    if (g_prefrontal_quantum_bridge_health_agent) {
