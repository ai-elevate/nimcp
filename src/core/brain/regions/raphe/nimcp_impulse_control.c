...
/** Global health agent for impulse_control module */
static nimcp_health_agent_t* g_impulse_control_health_agent = NULL;

/**
 * @brief Set health agent for impulse_control heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void impulse_control_set_health_agent(nimcp_health_agent_t* agent) {
    g_impulse_control_health_agent = agent;
}

/** @brief Send heartbeat from impulse_control module */
static inline void impulse_control_heartbeat(const char* operation, float progress) {
    if (g_impulse_control_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_impulse_control_health_agent, operation, progress);
    }
}
