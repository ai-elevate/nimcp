...
/** Global health agent for mood_regulation module */
static nimcp_health_agent_t* g_mood_regulation_health_agent = NULL;

/**
 * @brief Set health agent for mood_regulation heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void mood_regulation_set_health_agent(nimcp_health_agent_t* agent) {
    g_mood_regulation_health_agent = agent;
}

/** @brief Send heartbeat from mood_regulation module */
static inline void mood_regulation_heartbeat(const char* operation, float progress) {
    if (g_mood_regulation_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_mood_regulation_health_agent, operation, progress);
    }
}
