...
/** Global health agent for raphe module */
static nimcp_health_agent_t* g_raphe_health_agent = NULL;

/**
 * @brief Set health agent for raphe heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void raphe_set_health_agent(nimcp_health_agent_t* agent) {
    g_raphe_health_agent = agent;
}

/** @brief Send heartbeat from raphe module */
static inline void raphe_heartbeat(const char* operation, float progress) {
    if (g_raphe_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_raphe_health_agent, operation, progress);
    }
}
