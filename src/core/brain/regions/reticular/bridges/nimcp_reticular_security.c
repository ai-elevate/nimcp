...
/** Global health agent for reticular_security module */
static nimcp_health_agent_t* g_reticular_security_health_agent = NULL;

/**
 * @brief Set health agent for reticular_security heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void reticular_security_set_health_agent(nimcp_health_agent_t* agent) {
    g_reticular_security_health_agent = agent;
}

/** @brief Send heartbeat from reticular_security module */
static inline void reticular_security_heartbeat(const char* operation, float progress) {
    if (g_reticular_security_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_reticular_security_health_agent, operation, progress);
    }
}
