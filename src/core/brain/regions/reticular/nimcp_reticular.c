...
/** Global health agent for reticular module */
static nimcp_health_agent_t* g_reticular_health_agent = NULL;

/**
 * @brief Set health agent for reticular heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void reticular_set_health_agent(nimcp_health_agent_t* agent) {
    g_reticular_health_agent = agent;
}

/** @brief Send heartbeat from reticular module */
static inline void reticular_heartbeat(const char* operation, float progress) {
    if (g_reticular_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_reticular_health_agent, operation, progress);
    }
}
