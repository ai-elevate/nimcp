...
/** Global health agent for tactile_motor_bridge module */
static nimcp_health_agent_t* g_tactile_motor_bridge_health_agent = NULL;

/**
 * @brief Set health agent for tactile_motor_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void tactile_motor_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_tactile_motor_bridge_health_agent = agent;
}

/** @brief Send heartbeat from tactile_motor_bridge module */
static inline void tactile_motor_bridge_heartbeat(const char* operation, float progress) {
    if (g_tactile_motor_bridge_health_agent) {
