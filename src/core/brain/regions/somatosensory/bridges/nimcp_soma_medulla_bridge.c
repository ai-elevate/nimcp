...
/** Global health agent for soma_medulla_bridge module */
static nimcp_health_agent_t* g_soma_medulla_bridge_health_agent = NULL;

/**
 * @brief Set health agent for soma_medulla_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void soma_medulla_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_soma_medulla_bridge_health_agent = agent;
}

/** @brief Send heartbeat from soma_medulla_bridge module */
static inline void soma_medulla_bridge_heartbeat(const char* operation, float progress) {
    if (g_soma_medulla_bridge_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_soma_medulla_bridge_health_agent, operation, progress);
    }
}
