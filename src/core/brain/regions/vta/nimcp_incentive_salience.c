...
/** Global health agent for incentive_salience module */
static nimcp_health_agent_t* g_incentive_salience_health_agent = NULL;

/**
 * @brief Set health agent for incentive_salience heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void incentive_salience_set_health_agent(nimcp_health_agent_t* agent) {
    g_incentive_salience_health_agent = agent;
}

/** @brief Send heartbeat from incentive_salience module */
static inline void incentive_salience_heartbeat(const char* operation, float progress) {
    if (g_incentive_salience_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_incentive_salience_health_agent, operation, progress);
    }
}
