...
/** Global health agent for wernicke_nlp_bridge module */
static nimcp_health_agent_t* g_wernicke_nlp_bridge_health_agent = NULL;

/**
 * @brief Set health agent for wernicke_nlp_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void wernicke_nlp_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_wernicke_nlp_bridge_health_agent = agent;
}

/** @brief Send heartbeat from wernicke_nlp_bridge module */
static inline void wernicke_nlp_bridge_heartbeat(const char* operation, float progress) {
    if (g_wernicke_nlp_bridge_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_wernicke_nlp_bridge_health_agent, operation, progress);
    }
}
