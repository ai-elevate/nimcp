...
/** Global health agent for amygdala_stress_bridge module */
static nimcp_health_agent_t* g_amygdala_stress_bridge_health_agent = NULL;

/**
 * @brief Set health agent for amygdala_stress_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void amygdala_stress_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_amygdala_stress_bridge_health_agent = agent;
}

/** @brief Send heartbeat from amygdala_stress_bridge module */
static inline void amygdala_stress_bridge_heartbeat(const char* operation, float progress) {
    if (g_amygdala_stress_bridge_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_amygdala_stress_bridge_health_agent, operation, progress);
    }
}
