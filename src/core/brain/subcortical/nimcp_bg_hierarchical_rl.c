...
/** Global health agent for bg_hierarchical_rl module */
static nimcp_health_agent_t* g_bg_hierarchical_rl_health_agent = NULL;

/**
 * @brief Set health agent for bg_hierarchical_rl heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void bg_hierarchical_rl_set_health_agent(nimcp_health_agent_t* agent) {
    g_bg_hierarchical_rl_health_agent = agent;
}

/** @brief Send heartbeat from bg_hierarchical_rl module */
static inline void bg_hierarchical_rl_heartbeat(const char* operation, float progress) {
    if (g_bg_hierarchical_rl_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_bg_hierarchical_rl_health_agent, operation, progress);
    }
}
