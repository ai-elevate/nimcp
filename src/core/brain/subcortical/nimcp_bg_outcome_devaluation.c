...
/** Global health agent for bg_outcome_devaluation module */
static nimcp_health_agent_t* g_bg_outcome_devaluation_health_agent = NULL;

/**
 * @brief Set health agent for bg_outcome_devaluation heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void bg_outcome_devaluation_set_health_agent(nimcp_health_agent_t* agent) {
    g_bg_outcome_devaluation_health_agent = agent;
}

/** @brief Send heartbeat from bg_outcome_devaluation module */
static inline void bg_outcome_devaluation_heartbeat(const char* operation, float progress) {
    if (g_bg_outcome_devaluation_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_bg_outcome_devaluation_health_agent, operation, progress);
    }
}
