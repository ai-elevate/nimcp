...
/** Global health agent for striatal_interneurons module */
static nimcp_health_agent_t* g_striatal_interneurons_health_agent = NULL;

/**
 * @brief Set health agent for striatal_interneurons heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void striatal_interneurons_set_health_agent(nimcp_health_agent_t* agent) {
    g_striatal_interneurons_health_agent = agent;
}

/** @brief Send heartbeat from striatal_interneurons module */
static inline void striatal_interneurons_heartbeat(const char* operation, float progress) {
    if (g_striatal_interneurons_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_striatal_interneurons_health_agent, operation, progress);
    }
}
