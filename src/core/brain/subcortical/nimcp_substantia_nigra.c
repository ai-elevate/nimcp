...
/** Global health agent for substantia_nigra module */
static nimcp_health_agent_t* g_substantia_nigra_health_agent = NULL;

/**
 * @brief Set health agent for substantia_nigra heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void substantia_nigra_set_health_agent(nimcp_health_agent_t* agent) {
    g_substantia_nigra_health_agent = agent;
}

/** @brief Send heartbeat from substantia_nigra module */
static inline void substantia_nigra_heartbeat(const char* operation, float progress) {
    if (g_substantia_nigra_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_substantia_nigra_health_agent, operation, progress);
    }
}
