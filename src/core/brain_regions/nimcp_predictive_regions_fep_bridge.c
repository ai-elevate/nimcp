...
/** Global health agent for predictive_regions_fep_bridge module */
static nimcp_health_agent_t* g_predictive_regions_fep_bridge_health_agent = NULL;

/**
 * @brief Set health agent for predictive_regions_fep_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void predictive_regions_fep_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_predictive_regions_fep_bridge_health_agent = agent;
}

/** @brief Send heartbeat from predictive_regions_fep_bridge module */
static inline void predictive_regions_fep_bridge_heartbeat(const char* operation, float progress) {
    if (g_predictive_regions_fep_bridge_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_predictive_regions_fep_bridge_health_agent, operation, progress);
    }
}
