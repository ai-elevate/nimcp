...
/** Global health agent for brainstem_thalamic_bridge module */
static nimcp_health_agent_t* g_brainstem_thalamic_bridge_health_agent = NULL;

/**
 * @brief Set health agent for brainstem_thalamic_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void brainstem_thalamic_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_brainstem_thalamic_bridge_health_agent = agent;
}

/** @brief Send heartbeat from brainstem_thalamic_bridge module */
static inline void brainstem_thalamic_bridge_heartbeat(const char* operation, float progress) {
    if (g_brainstem_thalamic_bridge_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_brainstem_thalamic_bridge_health_agent, operation, progress);
    }
}
