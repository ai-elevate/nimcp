...
/** Global health agent for cortical_column_fep_bridge module */
static nimcp_health_agent_t* g_cortical_column_fep_bridge_health_agent = NULL;

/**
 * @brief Set health agent for cortical_column_fep_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void cortical_column_fep_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_cortical_column_fep_bridge_health_agent = agent;
}

/** @brief Send heartbeat from cortical_column_fep_bridge module */
static inline void cortical_column_fep_bridge_heartbeat(const char* operation, float progress) {
    if (g_cortical_column_fep_bridge_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_cortical_column_fep_bridge_health_agent, operation, progress);
    }
}
