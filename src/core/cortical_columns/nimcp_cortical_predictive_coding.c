...
/** Global health agent for cortical_predictive_coding module */
static nimcp_health_agent_t* g_cortical_predictive_coding_health_agent = NULL;

/**
 * @brief Set health agent for cortical_predictive_coding heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void cortical_predictive_coding_set_health_agent(nimcp_health_agent_t* agent) {
    g_cortical_predictive_coding_health_agent = agent;
}

/** @brief Send heartbeat from cortical_predictive_coding module */
static inline void cortical_predictive_coding_heartbeat(const char* operation, float progress) {
    if (g_cortical_predictive_coding_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_cortical_predictive_coding_health_agent, operation, progress);
    }
}
