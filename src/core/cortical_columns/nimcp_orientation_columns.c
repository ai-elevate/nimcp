...
/** Global health agent for orientation_columns module */
static nimcp_health_agent_t* g_orientation_columns_health_agent = NULL;

/**
 * @brief Set health agent for orientation_columns heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void orientation_columns_set_health_agent(nimcp_health_agent_t* agent) {
    g_orientation_columns_health_agent = agent;
}

/** @brief Send heartbeat from orientation_columns module */
static inline void orientation_columns_heartbeat(const char* operation, float progress) {
    if (g_orientation_columns_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_orientation_columns_health_agent, operation, progress);
    }
}
