...
/** Global health agent for action_history module */
static nimcp_health_agent_t* g_action_history_health_agent = NULL;

/**
 * @brief Set health agent for action_history heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void action_history_set_health_agent(nimcp_health_agent_t* agent) {
    g_action_history_health_agent = agent;
}

/** @brief Send heartbeat from action_history module */
static inline void action_history_heartbeat(const char* operation, float progress) {
    if (g_action_history_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_action_history_health_agent, operation, progress);
    }
}
