...
/** Global health agent for harm_classifier module */
static nimcp_health_agent_t* g_harm_classifier_health_agent = NULL;

/**
 * @brief Set health agent for harm_classifier heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void harm_classifier_set_health_agent(nimcp_health_agent_t* agent) {
    g_harm_classifier_health_agent = agent;
}

/** @brief Send heartbeat from harm_classifier module */
static inline void harm_classifier_heartbeat(const char* operation, float progress) {
    if (g_harm_classifier_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_harm_classifier_health_agent, operation, progress);
    }
}
