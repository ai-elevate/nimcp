...
/** Global health agent for harm_prevention module */
static nimcp_health_agent_t* g_harm_prevention_health_agent = NULL;

/**
 * @brief Set health agent for harm_prevention heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void harm_prevention_set_health_agent(nimcp_health_agent_t* agent) {
    g_harm_prevention_health_agent = agent;
}

/** @brief Send heartbeat from harm_prevention module */
static inline void harm_prevention_heartbeat(const char* operation, float progress) {
    if (g_harm_prevention_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_harm_prevention_health_agent, operation, progress);
    }
}
