...
/** Global health agent for self_preservation module */
static nimcp_health_agent_t* g_self_preservation_health_agent = NULL;

/**
 * @brief Set health agent for self_preservation heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void self_preservation_set_health_agent(nimcp_health_agent_t* agent) {
    g_self_preservation_health_agent = agent;
}

/** @brief Send heartbeat from self_preservation module */
static inline void self_preservation_heartbeat(const char* operation, float progress) {
    if (g_self_preservation_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_self_preservation_health_agent, operation, progress);
    }
}
