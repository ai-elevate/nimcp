...
/** Global health agent for core_bio_async_bridge module */
static nimcp_health_agent_t* g_core_bio_async_bridge_health_agent = NULL;

/**
 * @brief Set health agent for core_bio_async_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void core_bio_async_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_core_bio_async_bridge_health_agent = agent;
}

/** @brief Send heartbeat from core_bio_async_bridge module */
static inline void core_bio_async_bridge_heartbeat(const char* operation, float progress) {
    if (g_core_bio_async_bridge_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_core_bio_async_bridge_health_agent, operation, progress);
    }
}
