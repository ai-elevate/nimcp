...
/** Global health agent for multimodal_integration module */
static nimcp_health_agent_t* g_multimodal_integration_health_agent = NULL;

/**
 * @brief Set health agent for multimodal_integration heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void multimodal_integration_set_health_agent(nimcp_health_agent_t* agent) {
    g_multimodal_integration_health_agent = agent;
}

/** @brief Send heartbeat from multimodal_integration module */
static inline void multimodal_integration_heartbeat(const char* operation, float progress) {
    if (g_multimodal_integration_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_multimodal_integration_health_agent, operation, progress);
    }
}
