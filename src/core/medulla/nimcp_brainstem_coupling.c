...
/** Global health agent for brainstem_coupling module */
static nimcp_health_agent_t* g_brainstem_coupling_health_agent = NULL;

/**
 * @brief Set health agent for brainstem_coupling heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void brainstem_coupling_set_health_agent(nimcp_health_agent_t* agent) {
    g_brainstem_coupling_health_agent = agent;
}

/** @brief Send heartbeat from brainstem_coupling module */
static inline void brainstem_coupling_heartbeat(const char* operation, float progress) {
    if (g_brainstem_coupling_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_brainstem_coupling_health_agent, operation, progress);
    }
}
