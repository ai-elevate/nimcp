...
/** Global health agent for protective_cutoff module */
static nimcp_health_agent_t* g_protective_cutoff_health_agent = NULL;

/**
 * @brief Set health agent for protective_cutoff heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void protective_cutoff_set_health_agent(nimcp_health_agent_t* agent) {
    g_protective_cutoff_health_agent = agent;
}

/** @brief Send heartbeat from protective_cutoff module */
static inline void protective_cutoff_heartbeat(const char* operation, float progress) {
    if (g_protective_cutoff_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_protective_cutoff_health_agent, operation, progress);
    }
}
