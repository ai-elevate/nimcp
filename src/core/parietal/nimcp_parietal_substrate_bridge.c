...
/** Global health agent for parietal_substrate_bridge module */
static nimcp_health_agent_t* g_parietal_substrate_bridge_health_agent = NULL;

/**
 * @brief Set health agent for parietal_substrate_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void parietal_substrate_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_parietal_substrate_bridge_health_agent = agent;
}

/** @brief Send heartbeat from parietal_substrate_bridge module */
static inline void parietal_substrate_bridge_heartbeat(const char* operation, float progress) {
    if (g_parietal_substrate_bridge_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_parietal_substrate_bridge_health_agent, operation, progress);
    }
}
