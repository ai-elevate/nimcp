...
/** Global health agent for synapse_substrate_bridge module */
static nimcp_health_agent_t* g_synapse_substrate_bridge_health_agent = NULL;

/**
 * @brief Set health agent for synapse_substrate_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void synapse_substrate_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_synapse_substrate_bridge_health_agent = agent;
}

/** @brief Send heartbeat from synapse_substrate_bridge module */
static inline void synapse_substrate_bridge_heartbeat(const char* operation, float progress) {
    if (g_synapse_substrate_bridge_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_synapse_substrate_bridge_health_agent, operation, progress);
    }
}
