...
/** Global health agent for dragonfly_multi_target module */
static nimcp_health_agent_t* g_dragonfly_multi_target_health_agent = NULL;

/**
 * @brief Set health agent for dragonfly_multi_target heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void dragonfly_multi_target_set_health_agent(nimcp_health_agent_t* agent) {
    g_dragonfly_multi_target_health_agent = agent;
}

/** @brief Send heartbeat from dragonfly_multi_target module */
static inline void dragonfly_multi_target_heartbeat(const char* operation, float progress) {
    if (g_dragonfly_multi_target_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_dragonfly_multi_target_health_agent, operation, progress);
    }
}
