...
/** Global health agent for affordance_processing module */
static nimcp_health_agent_t* g_affordance_processing_health_agent = NULL;

/**
 * @brief Set health agent for affordance_processing heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void affordance_processing_set_health_agent(nimcp_health_agent_t* agent) {
    g_affordance_processing_health_agent = agent;
}

/** @brief Send heartbeat from affordance_processing module */
static inline void affordance_processing_heartbeat(const char* operation, float progress) {
    if (g_affordance_processing_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_affordance_processing_health_agent, operation, progress);
    }
}
