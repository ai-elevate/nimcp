...
/** Global health agent for interoceptive_prediction module */
static nimcp_health_agent_t* g_interoceptive_prediction_health_agent = NULL;

/**
 * @brief Set health agent for interoceptive_prediction heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void interoceptive_prediction_set_health_agent(nimcp_health_agent_t* agent) {
    g_interoceptive_prediction_health_agent = agent;
}

/** @brief Send heartbeat from interoceptive_prediction module */
static inline void interoceptive_prediction_heartbeat(const char* operation, float progress) {
    if (g_interoceptive_prediction_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_interoceptive_prediction_health_agent, operation, progress);
    }
}
