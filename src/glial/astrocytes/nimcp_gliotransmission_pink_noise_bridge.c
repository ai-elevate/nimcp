...
/** Global health agent for gliotransmission_pink_noise_bridge module */
static nimcp_health_agent_t* g_gliotransmission_pink_noise_bridge_health_agent = NULL;

/**
 * @brief Set health agent for gliotransmission_pink_noise_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void gliotransmission_pink_noise_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_gliotransmission_pink_noise_bridge_health_agent = agent;
}

/** @brief Send heartbeat from gliotransmission_pink_noise_bridge module */
static inline void gliotransmission_pink_noise_bridge_heartbeat(const char* operation, float progress) {
    if (g_gliotransmission_pink_noise_bridge_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_gliotransmission_pink_noise_bridge_health_agent, operation, progress);
    }
}
