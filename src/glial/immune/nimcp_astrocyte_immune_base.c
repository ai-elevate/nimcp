...
/** Global health agent for astrocyte_immune_base module */
static nimcp_health_agent_t* g_astrocyte_immune_base_health_agent = NULL;

/**
 * @brief Set health agent for astrocyte_immune_base heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void astrocyte_immune_base_set_health_agent(nimcp_health_agent_t* agent) {
    g_astrocyte_immune_base_health_agent = agent;
}

/** @brief Send heartbeat from astrocyte_immune_base module */
static inline void astrocyte_immune_base_heartbeat(const char* operation, float progress) {
    if (g_astrocyte_immune_base_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_astrocyte_immune_base_health_agent, operation, progress);
    }
}
