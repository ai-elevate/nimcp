...
/** Global health agent for glial_substrate_bridge module */
static nimcp_health_agent_t* g_glial_substrate_bridge_health_agent = NULL;

/**
 * @brief Set health agent for glial_substrate_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void glial_substrate_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_glial_substrate_bridge_health_agent = agent;
}

/** @brief Send heartbeat from glial_substrate_bridge module */
static inline void glial_substrate_bridge_heartbeat(const char* operation, float progress) {
    if (g_glial_substrate_bridge_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_glial_substrate_bridge_health_agent, operation, progress);
    }
}
