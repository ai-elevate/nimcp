...
/** Global health agent for oligodendrocytes module */
static nimcp_health_agent_t* g_oligodendrocytes_health_agent = NULL;

/**
 * @brief Set health agent for oligodendrocytes heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void oligodendrocytes_set_health_agent(nimcp_health_agent_t* agent) {
    g_oligodendrocytes_health_agent = agent;
}

/** @brief Send heartbeat from oligodendrocytes module */
static inline void oligodendrocytes_heartbeat(const char* operation, float progress) {
    if (g_oligodendrocytes_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_oligodendrocytes_health_agent, operation, progress);
    }
}
