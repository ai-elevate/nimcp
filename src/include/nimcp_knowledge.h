 ...
 */
uint32_t knowledge_learn_from_text(
 ...
 */
bool knowledge_learn_from_story(
    knowledge_system_t system,
 ...
 * @return true on success
 */
bool knowledge_learn_from_history(
    knowledge_system_t system,
 ...
 * @return Number of concepts learned
 */
uint32_t knowledge_learn_from_conversation(
    knowledge_system_t system,
    const char* dialogue,
 ...
 * @return true on success
 */
bool knowledge_learn_from_demonstration(
    knowledge_system_t system,
 ...
 * @return Length of explanation
 */
uint32_t knowledge_explain_simply(
    knowledge_system_t system,
    const char* concept,
    uint32_t target_age,
    char* explanation,
 ...
 * @return true on success
 */
bool knowledge_build_on(
    knowledge_system_t system,
    const char* new_concept,
    const char* based_on_concept,
 ...
 * @return true on success
 */
bool knowledge_organize_domain(
    knowledge_system_t system,
    knowledge_domain_t domain
);
 ...
 * @return Number of concepts learned
 */
uint32_t knowledge_read_book(
    knowledge_system_t system,
    const char* book_title,
    const char* book_text,
    uint32_t reading_speed
);
 ...
 */
uint32_t knowledge_continue_reading(
    knowledge_system_t system,
    const char* book_title,
 ...
 */
uint32_t knowledge_get_reading_list(
    knowledge_system_t system,
    knowledge_domain_t domain,
 ...
 */
uint32_t knowledge_get_summary(
    knowledge_system_t system,
