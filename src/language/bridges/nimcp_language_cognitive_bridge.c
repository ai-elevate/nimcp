...
/** Global health agent for language_cognitive_bridge module */
static nimcp_health_agent_t* g_language_cognitive_bridge_health_agent = NULL;

/**
 * @brief Set health agent for language_cognitive_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void language_cognitive_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_language_cognitive_bridge_health_agent = agent;
}

/** @brief Send heartbeat from language_cognitive_bridge module */
static inline void language_cognitive_bridge_heartbeat(const char* operation, float progress) {
    if (g_language_cognitive_bridge_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_language_cognitive_bridge_health_agent, operation, progress);
    }
}
