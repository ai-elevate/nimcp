...
/** Global health agent for language_insula_bridge module */
static nimcp_health_agent_t* g_language_insula_bridge_health_agent = NULL;

/**
 * @brief Set health agent for language_insula_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void language_insula_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_language_insula_bridge_health_agent = agent;
}

/** @brief Send heartbeat from language_insula_bridge module */
static inline void language_insula_bridge_heartbeat(const char* operation, float progress) {
    if (g_language_insula_bridge_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_language_insula_bridge_health_agent, operation, progress);
    }
}

#define LOG_MODULE "LANGUAGE_INSULA_BRIDGE"
