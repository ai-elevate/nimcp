...
static int cascade_stage_content(brain_t brain,
    ...
    /* SLICE 3 — Record stage-content prediction error. We use the
     * snapshot above (PRE-arcuate) as the prediction; the now-modified
     * content_intent is the observation. */
