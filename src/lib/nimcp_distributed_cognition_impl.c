...
/** Global health agent for distributed_cognition_impl module */
static nimcp_health_agent_t* g_distributed_cognition_impl_health_agent = NULL;

/**
 * @brief Set health agent for distributed_cognition_impl heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void distributed_cognition_impl_set_health_agent(nimcp_health_agent_t* agent) {
    g_distributed_cognition_impl_health_agent = agent;
}

/** @brief Send heartbeat from distributed_cognition_impl module */
static inline void distributed_cognition_impl_heartbeat(const char* operation, float progress) {
    if (g_distributed_cognition_impl_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_distributed_cognition_impl_health_agent, operation, progress);
    }
}
