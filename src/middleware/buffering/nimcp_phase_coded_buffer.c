...
/** Global health agent for phase_coded_buffer module */
static nimcp_health_agent_t* g_phase_coded_buffer_health_agent = NULL;

/**
 * @brief Set health agent for phase_coded_buffer heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void phase_coded_buffer_set_health_agent(nimcp_health_agent_t* agent) {
    g_phase_coded_buffer_health_agent = agent;
}

/** @brief Send heartbeat from phase_coded_buffer module */
static inline void phase_coded_buffer_heartbeat(const char* operation, float progress) {
    if (g_phase_coded_buffer_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_phase_coded_buffer_health_agent, operation, progress);
    }
}
