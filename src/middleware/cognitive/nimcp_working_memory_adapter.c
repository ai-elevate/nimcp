...
/** Global health agent for working_memory_adapter module */
static nimcp_health_agent_t* g_working_memory_adapter_health_agent = NULL;

/**
 * @brief Set health agent for working_memory_adapter heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void working_memory_adapter_set_health_agent(nimcp_health_agent_t* agent) {
    g_working_memory_adapter_health_agent = agent;
}

/** @brief Send heartbeat from working_memory_adapter module */
static inline void working_memory_adapter_heartbeat(const char* operation, float progress) {
    if (g_working_memory_adapter_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_working_memory_adapter_health_agent, operation, progress);
    }
}
