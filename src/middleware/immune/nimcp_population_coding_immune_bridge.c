...
population_immune_bridge_t* population_immune_bridge_create(
    ...
    if (!immune_system || !population_encoder) {
        nimcp_log(NIMCP_LOG_ERROR, "population_immune_bridge",
    ...
    nimcp_log(NIMCP_LOG_INFO, "population_immune_bridge",
...
void population_immune_bridge_destroy(population_immune_bridge_t* bridge) {
    ...
    nimcp_free(bridge);
    nimcp_log(NIMCP_LOG_INFO, "population_immune_bridge", "Bridge destroyed");
}
