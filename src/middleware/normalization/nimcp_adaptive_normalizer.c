...
/** Global health agent for adaptive_normalizer module */
static nimcp_health_agent_t* g_adaptive_normalizer_health_agent = NULL;

/**
 * @brief Set health agent for adaptive_normalizer heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void adaptive_normalizer_set_health_agent(nimcp_health_agent_t* agent) {
    g_adaptive_normalizer_health_agent = agent;
}

/** @brief Send heartbeat from adaptive_normalizer module */
static inline void adaptive_normalizer_heartbeat(const char* operation, float progress) {
    if (g_adaptive_normalizer_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_adaptive_normalizer_health_agent, operation, progress);
    }
}
