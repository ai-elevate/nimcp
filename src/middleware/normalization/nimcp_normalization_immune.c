...
/** Global health agent for normalization_immune module */
static nimcp_health_agent_t* g_normalization_immune_health_agent = NULL;

/**
 * @brief Set health agent for normalization_immune heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void normalization_immune_set_health_agent(nimcp_health_agent_t* agent) {
    g_normalization_immune_health_agent = agent;
}

/** @brief Send heartbeat from normalization_immune module */
static inline void normalization_immune_heartbeat(const char* operation, float progress) {
    if (g_normalization_immune_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_normalization_immune_health_agent, operation, progress);
    }
}
