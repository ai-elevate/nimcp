...
/** Global health agent for cognitive_training_bridge module */
static nimcp_health_agent_t* g_cognitive_training_bridge_health_agent = NULL;

/**
 * @brief Set health agent for cognitive_training_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void cognitive_training_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_cognitive_training_bridge_health_agent = agent;
}

/** @brief Send heartbeat from cognitive_training_bridge module */
static inline void cognitive_training_bridge_heartbeat(const char* operation, float progress) {
    if (g_cognitive_training_bridge_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_cognitive_training_bridge_health_agent, operation, progress);
    }
}
