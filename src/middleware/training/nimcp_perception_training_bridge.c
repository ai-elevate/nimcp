...
/** Global health agent for perception_training_bridge module */
static nimcp_health_agent_t* g_perception_training_bridge_health_agent = NULL;

/**
 * @brief Set health agent for perception_training_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void perception_training_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_perception_training_bridge_health_agent = agent;
}

/** @brief Send heartbeat from perception_training_bridge module */
static inline void perception_training_bridge_heartbeat(const char* operation, float progress) {
    if (g_perception_training_bridge_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_perception_training_bridge_health_agent, operation, progress);
    }
}
