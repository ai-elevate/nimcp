...
/** Global health agent for nlp_protocol_bridge module */
static nimcp_health_agent_t* g_nlp_protocol_bridge_health_agent = NULL;

/**
 * @brief Set health agent for nlp_protocol_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void nlp_protocol_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_nlp_protocol_bridge_health_agent = agent;
}

/** @brief Send heartbeat from nlp_protocol_bridge module */
static inline void nlp_protocol_bridge_heartbeat(const char* operation, float progress) {
    if (g_nlp_protocol_bridge_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_nlp_protocol_bridge_health_agent, operation, progress);
    }
}
