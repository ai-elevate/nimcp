...
/** Global health agent for msg_framing module */
static nimcp_health_agent_t* g_msg_framing_health_agent = NULL;

/**
 * @brief Set health agent for msg_framing heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void msg_framing_set_health_agent(nimcp_health_agent_t* agent) {
    g_msg_framing_health_agent = agent;
}

/** @brief Send heartbeat from msg_framing module */
static inline void msg_framing_heartbeat(const char* operation, float progress) {
    if (g_msg_framing_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_msg_framing_health_agent, operation, progress);
    }
}
