...
/** Global health agent for quantum_annealing_immune_bridge module */
static nimcp_health_agent_t* g_quantum_annealing_immune_bridge_health_agent = NULL;

/**
 * @brief Set health agent for quantum_annealing_immune_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void quantum_annealing_immune_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_quantum_annealing_immune_bridge_health_agent = agent;
}

/** @brief Send heartbeat from quantum_annealing_immune_bridge module */
static inline void quantum_annealing_immune_bridge_heartbeat(const char* operation, float progress) {
    if (g_quantum_annealing_immune_bridge_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_quantum_annealing_immune_bridge_health_agent, operation, progress);
    }
}
