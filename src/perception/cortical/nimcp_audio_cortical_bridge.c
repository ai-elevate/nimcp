...
/** Global health agent for audio_cortical_bridge module */
static nimcp_health_agent_t* g_audio_cortical_bridge_health_agent = NULL;

/**
 * @brief Set health agent for audio_cortical_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void audio_cortical_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_audio_cortical_bridge_health_agent = agent;
}

/** @brief Send heartbeat from audio_cortical_bridge module */
static inline void audio_cortical_bridge_heartbeat(const char* operation, float progress) {
    if (g_audio_cortical_bridge_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_audio_cortical_bridge_health_agent, operation, progress);
    }
}
