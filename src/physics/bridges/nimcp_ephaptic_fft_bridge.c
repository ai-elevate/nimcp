...
/** Global health agent for ephaptic_fft_bridge module */
static nimcp_health_agent_t* g_ephaptic_fft_bridge_health_agent = NULL;

/**
 * @brief Set health agent for ephaptic_fft_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void ephaptic_fft_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_ephaptic_fft_bridge_health_agent = agent;
}

/** @brief Send heartbeat from ephaptic_fft_bridge module */
static inline void ephaptic_fft_bridge_heartbeat(const char* operation, float progress) {
    if (g_ephaptic_fft_bridge_health_agent) {
