...
/** Global health agent for physics_lnn_bridge module */
static nimcp_health_agent_t* g_physics_lnn_bridge_health_agent = NULL;

/**
 * @brief Set health agent for physics_lnn_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void physics_lnn_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_physics_lnn_bridge_health_agent = agent;
}

/** @brief Send heartbeat from physics_lnn_bridge module */
static inline void physics_lnn_bridge_heartbeat(const char* operation, float progress) {
    if (g_physics_lnn_bridge_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_physics_lnn_bridge_health_agent, operation, progress);
    }
}
