...
/** Global health agent for axon_plasticity_bridge module */
static nimcp_health_agent_t* g_axon_plasticity_bridge_health_agent = NULL;

/**
 * @brief Set health agent for axon_plasticity_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void axon_plasticity_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_axon_plasticity_bridge_health_agent = agent;
}

/** @brief Send heartbeat from axon_plasticity_bridge module */
static inline void axon_plasticity_bridge_heartbeat(const char* operation, float progress) {
    if (g_axon_plasticity_bridge_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_axon_plasticity_bridge_health_agent, operation, progress);
    }
}
