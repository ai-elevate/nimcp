...
/** Global health agent for dendritic_pink_noise_bridge module */
static nimcp_health_agent_t* g_dendritic_pink_noise_bridge_health_agent = NULL;

/**
 * @brief Set health agent for dendritic_pink_noise_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void dendritic_pink_noise_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_dendritic_pink_noise_bridge_health_agent = agent;
}

/** @brief Send heartbeat from dendritic_pink_noise_bridge module */
static inline void dendritic_pink_noise_bridge_heartbeat(const char* operation, float progress) {
    if (g_dendritic_pink_noise_bridge_health_agent) {
