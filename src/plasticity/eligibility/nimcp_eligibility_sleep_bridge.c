...
/** Global health agent for eligibility_sleep_bridge module */
static nimcp_health_agent_t* g_eligibility_sleep_bridge_health_agent = NULL;

/**
 * @brief Set health agent for eligibility_sleep_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void eligibility_sleep_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_eligibility_sleep_bridge_health_agent = agent;
}

/** @brief Send heartbeat from eligibility_sleep_bridge module */
static inline void eligibility_sleep_bridge_heartbeat(const char* operation, float progress) {
    if (g_eligibility_sleep_bridge_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_eligibility_sleep_bridge_health_agent, operation, progress);
    }
}
...
BRIDGE_DEFINE_SECURITY_SETTERS_TYPE(eligibility_sleep_bridge, struct eligibility_sleep_bridge_struct)
