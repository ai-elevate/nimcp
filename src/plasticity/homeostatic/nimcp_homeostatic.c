...
/** Global health agent for homeostatic module */
static nimcp_health_agent_t* g_homeostatic_health_agent = NULL;

/**
 * @brief Set health agent for homeostatic heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void homeostatic_set_health_agent(nimcp_health_agent_t* agent) {
    g_homeostatic_health_agent = agent;
}

/** @brief Send heartbeat from homeostatic module */
static inline void homeostatic_heartbeat(const char* operation, float progress) {
    if (g_homeostatic_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_homeostatic_health_agent, operation, progress);
    }
}
