...
/** Global health agent for metabolic_pink_noise_bridge module */
static nimcp_health_agent_t* g_metabolic_pink_noise_bridge_health_agent = NULL;

/**
 * @brief Set health agent for metabolic_pink_noise_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void metabolic_pink_noise_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_metabolic_pink_noise_bridge_health_agent = agent;
}

/** @brief Send heartbeat from metabolic_pink_noise_bridge module */
static inline void metabolic_pink_noise_bridge_heartbeat(const char* operation, float progress) {
    if (g_metabolic_pink_noise_bridge_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_metabolic_pink_noise_bridge_health_agent, operation, progress);
    }
}
