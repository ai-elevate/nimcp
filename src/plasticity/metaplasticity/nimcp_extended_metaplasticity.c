...
/** Global health agent for extended_metaplasticity module */
static nimcp_health_agent_t* g_extended_metaplasticity_health_agent = NULL;

/**
 * @brief Set health agent for extended_metaplasticity heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void extended_metaplasticity_set_health_agent(nimcp_health_agent_t* agent) {
    g_extended_metaplasticity_health_agent = agent;
}

/** @brief Send heartbeat from extended_metaplasticity module */
static inline void extended_metaplasticity_heartbeat(const char* operation, float progress) {
    if (g_extended_metaplasticity_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_extended_metaplasticity_health_agent, operation, progress);
    }
}
