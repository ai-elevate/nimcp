...
/** Global health agent for neuromod_substrate_bridge module */
static nimcp_health_agent_t* g_neuromod_substrate_bridge_health_agent = NULL;

/**
 * @brief Set health agent for neuromod_substrate_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void neuromod_substrate_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_neuromod_substrate_bridge_health_agent = agent;
}

/** @brief Send heartbeat from neuromod_substrate_bridge module */
static inline void neuromod_substrate_bridge_heartbeat(const char* operation, float progress) {
    if (g_neuromod_substrate_bridge_health_agent) {
