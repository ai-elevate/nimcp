...
/** Global health agent for phasic_tonic module */
static nimcp_health_agent_t* g_phasic_tonic_health_agent = NULL;

/**
 * @brief Set health agent for phasic_tonic heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void phasic_tonic_set_health_agent(nimcp_health_agent_t* agent) {
    g_phasic_tonic_health_agent = agent;
}

/** @brief Send heartbeat from phasic_tonic module */
static inline void phasic_tonic_heartbeat(const char* operation, float progress) {
    if (g_phasic_tonic_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_phasic_tonic_health_agent, operation, progress);
    }
}
