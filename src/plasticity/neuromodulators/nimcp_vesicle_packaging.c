...
/** Global health agent for vesicle_packaging module */
static nimcp_health_agent_t* g_vesicle_packaging_health_agent = NULL;

/**
 * @brief Set health agent for vesicle_packaging heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void vesicle_packaging_set_health_agent(nimcp_health_agent_t* agent) {
    g_vesicle_packaging_health_agent = agent;
}

/** @brief Send heartbeat from vesicle_packaging module */
static inline void vesicle_packaging_heartbeat(const char* operation, float progress) {
    if (g_vesicle_packaging_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_vesicle_packaging_health_agent, operation, progress);
    }
}
