...
/** Global health agent for pink_noise_immune_bridge module */
static nimcp_health_agent_t* g_pink_noise_immune_bridge_health_agent = NULL;

/**
 * @brief Set health agent for pink_noise_immune_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void pink_noise_immune_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_pink_noise_immune_bridge_health_agent = agent;
}

/** @brief Send heartbeat from pink_noise_immune_bridge module */
static inline void pink_noise_immune_bridge_heartbeat(const char* operation, float progress) {
    if (g_pink_noise_immune_bridge_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_pink_noise_immune_bridge_health_agent, operation, progress);
    }
}

/* Security integration */
BRIDGE_DEFINE_SECURITY_SETTERS(pink_immune_bridge)
