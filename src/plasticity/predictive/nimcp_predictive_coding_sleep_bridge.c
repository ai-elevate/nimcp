...
NIMCP_DECLARE_HEALTH_AGENT_ATOMIC(predictive_coding_sleep_bridge)
...
BRIDGE_DEFINE_SECURITY_SETTERS_TYPE(predictive_sleep_bridge, struct predictive_sleep_bridge_struct)
