...
/** Global health agent for second_messengers module */
static nimcp_health_agent_t* g_second_messengers_health_agent = NULL;

/**
 * @brief Set health agent for second_messengers heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void second_messengers_set_health_agent(nimcp_health_agent_t* agent) {
    g_second_messengers_health_agent = agent;
}

/** @brief Send heartbeat from second_messengers module */
static inline void second_messengers_heartbeat(const char* operation, float progress) {
    if (g_second_messengers_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_second_messengers_health_agent, operation, progress);
    }
}
