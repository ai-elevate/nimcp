...
/** Global health agent for stdp_fep_bridge module */
static nimcp_health_agent_t* g_stdp_fep_bridge_health_agent = NULL;

/**
 * @brief Set health agent for stdp_fep_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void stdp_fep_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_stdp_fep_bridge_health_agent = agent;
}

/** @brief Send heartbeat from stdp_fep_bridge module */
static inline void stdp_fep_bridge_heartbeat(const char* operation, float progress) {
    if (g_stdp_fep_bridge_health_agent) {
