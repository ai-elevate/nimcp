...
/** Global health agent for quantum_bio_async_bridge module */
static nimcp_health_agent_t* g_quantum_bio_async_bridge_health_agent = NULL;

/**
 * @brief Set health agent for quantum_bio_async_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void quantum_bio_async_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_quantum_bio_async_bridge_health_agent = agent;
}

/** @brief Send heartbeat from quantum_bio_async_bridge module */
static inline void quantum_bio_async_bridge_heartbeat(const char* operation, float progress) {
    if (g_quantum_bio_async_bridge_health_agent) {
