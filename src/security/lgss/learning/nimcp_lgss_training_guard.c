...
/** Global health agent for lgss_training_guard module */
static nimcp_health_agent_t* g_lgss_training_guard_health_agent = NULL;

/**
 * @brief Set health agent for lgss_training_guard heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void lgss_training_guard_set_health_agent(nimcp_health_agent_t* agent) {
    g_lgss_training_guard_health_agent = agent;
}

/** @brief Send heartbeat from lgss_training_guard module */
static inline void lgss_training_guard_heartbeat(const char* operation, float progress) {
    if (g_lgss_training_guard_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_lgss_training_guard_health_agent, operation, progress);
    }
}
