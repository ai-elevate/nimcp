...
/** Global health agent for lgss_override_controller module */
static nimcp_health_agent_t* g_lgss_override_controller_health_agent = NULL;

/**
 * @brief Set health agent for lgss_override_controller heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void lgss_override_controller_set_health_agent(nimcp_health_agent_t* agent) {
    g_lgss_override_controller_health_agent = agent;
}

/** @brief Send heartbeat from lgss_override_controller module */
static inline void lgss_override_controller_heartbeat(const char* operation, float progress) {
