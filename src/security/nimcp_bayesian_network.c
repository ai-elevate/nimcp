...
/** Global health agent for bayesian_network module */
static nimcp_health_agent_t* g_bayesian_network_health_agent = NULL;

/**
 * @brief Set health agent for bayesian_network heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void bayesian_network_set_health_agent(nimcp_health_agent_t* agent) {
    g_bayesian_network_health_agent = agent;
}

/** @brief Send heartbeat from bayesian_network module */
static inline void bayesian_network_heartbeat(const char* operation, float progress) {
    if (g_bayesian_network_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_bayesian_network_health_agent, operation, progress);
    }
}
