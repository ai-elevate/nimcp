...
/** Global health agent for bbb_input_gate module */
static nimcp_health_agent_t* g_bbb_input_gate_health_agent = NULL;

/**
 * @brief Set health agent for bbb_input_gate heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void bbb_input_gate_set_health_agent(nimcp_health_agent_t* agent) {
    g_bbb_input_gate_health_agent = agent;
}

/** @brief Send heartbeat from bbb_input_gate module */
static inline void bbb_input_gate_heartbeat(const char* operation, float progress) {
    if (g_bbb_input_gate_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_bbb_input_gate_health_agent, operation, progress);
    }
}
