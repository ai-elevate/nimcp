...
/** Global health agent for blood_brain_barrier_fep_bridge module */
static nimcp_health_agent_t* g_blood_brain_barrier_fep_bridge_health_agent = NULL;

/**
 * @brief Set health agent for blood_brain_barrier_fep_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void blood_brain_barrier_fep_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_blood_brain_barrier_fep_bridge_health_agent = agent;
}

/** @brief Send heartbeat from blood_brain_barrier_fep_bridge module */
static inline void blood_brain_barrier_fep_bridge_heartbeat(const char* operation, float progress) {
    if (g_blood_brain_barrier_fep_bridge_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_blood_brain_barrier_fep_bridge_health_agent, operation, progress);
    }
}
