...
NIMCP_DECLARE_HEALTH_AGENT_ATOMIC(capability)
//=============================================================================
...
nimcp_error_t capability_mesh_register(mesh_participant_registry_t* registry) {
...
void capability_mesh_unregister(void) {
