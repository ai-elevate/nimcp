...
/** Global health agent for consensus_protocol module */
static nimcp_health_agent_t* g_consensus_protocol_health_agent = NULL;

/**
 * @brief Set health agent for consensus_protocol heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void consensus_protocol_set_health_agent(nimcp_health_agent_t* agent) {
    g_consensus_protocol_health_agent = agent;
}

/** @brief Send heartbeat from consensus_protocol module */
static inline void consensus_protocol_heartbeat(const char* operation, float progress) {
    if (g_consensus_protocol_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_consensus_protocol_health_agent, operation, progress);
    }
}
