...
/** Global health agent for pattern_compiler module */
static nimcp_health_agent_t* g_pattern_compiler_health_agent = NULL;

/**
 * @brief Set health agent for pattern_compiler heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void pattern_compiler_set_health_agent(nimcp_health_agent_t* agent) {
    g_pattern_compiler_health_agent = agent;
}

/** @brief Send heartbeat from pattern_compiler module */
static inline void pattern_compiler_heartbeat(const char* operation, float progress) {
    if (g_pattern_compiler_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_pattern_compiler_health_agent, operation, progress);
    }
}
