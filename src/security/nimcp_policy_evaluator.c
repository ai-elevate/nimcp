...
/** Global health agent for policy_evaluator module */
static nimcp_health_agent_t* g_policy_evaluator_health_agent = NULL;

/**
 * @brief Set health agent for policy_evaluator heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void policy_evaluator_set_health_agent(nimcp_health_agent_t* agent) {
    g_policy_evaluator_health_agent = agent;
}

/** @brief Send heartbeat from policy_evaluator module */
static inline void policy_evaluator_heartbeat(const char* operation, float progress) {
    if (g_policy_evaluator_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_policy_evaluator_health_agent, operation, progress);
    }
}
