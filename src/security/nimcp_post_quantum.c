...
/** Global health agent for post_quantum module */
static nimcp_health_agent_t* g_post_quantum_health_agent = NULL;

/**
 * @brief Set health agent for post_quantum heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void post_quantum_set_health_agent(nimcp_health_agent_t* agent) {
    g_post_quantum_health_agent = agent;
}

/** @brief Send heartbeat from post_quantum module */
static inline void post_quantum_heartbeat(const char* operation, float progress) {
    if (g_post_quantum_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_post_quantum_health_agent, operation, progress);
    }
}
