...
/** Global health agent for security_fractal module */
static nimcp_health_agent_t* g_security_fractal_health_agent = NULL;

/**
 * @brief Set health agent for security_fractal heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void security_fractal_set_health_agent(nimcp_health_agent_t* agent) {
    g_security_fractal_health_agent = agent;
}

/** @brief Send heartbeat from security_fractal module */
static inline void security_fractal_heartbeat(const char* operation, float progress) {
    if (g_security_fractal_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_security_fractal_health_agent, operation, progress);
    }
}
