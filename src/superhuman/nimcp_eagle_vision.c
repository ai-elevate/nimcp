...
/** Global health agent for eagle_vision module */
static nimcp_health_agent_t* g_eagle_vision_health_agent = NULL;

/**
 * @brief Set health agent for eagle_vision heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void eagle_vision_set_health_agent(nimcp_health_agent_t* agent) {
    g_eagle_vision_health_agent = agent;
}

/** @brief Send heartbeat from eagle_vision module */
static inline void eagle_vision_heartbeat(const char* operation, float progress) {
    if (g_eagle_vision_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_eagle_vision_health_agent, operation, progress);
    }
}
