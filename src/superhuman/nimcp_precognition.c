...
/** Global health agent for precognition module */
static nimcp_health_agent_t* g_precognition_health_agent = NULL;

/**
 * @brief Set health agent for precognition heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void precognition_set_health_agent(nimcp_health_agent_t* agent) {
    g_precognition_health_agent = agent;
}

/** @brief Send heartbeat from precognition module */
static inline void precognition_heartbeat(const char* operation, float progress) {
    if (g_precognition_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_precognition_health_agent, operation, progress);
    }
}
