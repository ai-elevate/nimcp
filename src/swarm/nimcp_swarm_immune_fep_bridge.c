...
/** Global health agent for swarm_immune_fep_bridge module */
static nimcp_health_agent_t* g_swarm_immune_fep_bridge_health_agent = NULL;

/**
 * @brief Set health agent for swarm_immune_fep_bridge heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void swarm_immune_fep_bridge_set_health_agent(nimcp_health_agent_t* agent) {
    g_swarm_immune_fep_bridge_health_agent = agent;
}

/** @brief Send heartbeat from swarm_immune_fep_bridge module */
static inline void swarm_immune_fep_bridge_heartbeat(const char* operation, float progress) {
    if (g_swarm_immune_fep_bridge_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_swarm_immune_fep_bridge_health_agent, operation, progress);
    }
}
...
int swarm_immune_fep_connect_bio_async(swarm_immune_fep_bridge_t* bridge) {
    ...
    bio_module_info_t info = { .module_id = BIO_MODULE_FEP_SWARM_IMMUNE, .module_name = "swarm_immune_fep_bridge", .inbox_capacity = NIMCP_INBOX_CAPACITY_SMALL, .user_data = bridge };
