...
TEST_F(NIMCPModuleTest, NetworkConfigCreation) {
    ...
    PyObject* args = Py_BuildValue("(ifffffff)", 
        test_config.num_neurons,
        test_config.ei_ratio,
        test_config.learning_rate,
        test_config.hebbian_rate,
        test_config.stdp_window,
        test_config.homeostatic_rate,
        test_config.target_activity,
        test_config.adaptation_rate
    );
...
TEST_F(NIMCPModuleTest, NodeConfigCreation) {
    ...
    PyObject* args = Py_BuildValue("(Hiiiii)", 
        test_config.listen_port,
        test_config.max_peers,
        test_config.keepalive_interval,
        test_config.discovery_interval,
        test_config.reconnect_interval,
