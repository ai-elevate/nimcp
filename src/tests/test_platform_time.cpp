...
TEST_F(TimeFormattingTest, FormatSmallTime)
{
    ...
    EXPECT_THAT(std::string(buffer), ::testing::ContainsRegex("0 d.*0 h.*0 m.*0 s.*500.*ms"))
...
TEST_F(TimeFormattingTest, FormatWithSeconds)
{
    ...
    EXPECT_EQ(result, 0) << "Should format successfully";
    EXPECT_THAT(std::string(buffer), ::testing::ContainsRegex("1 m.*5 s"))
...
TEST_F(TimeFormattingTest, FormatWithMinutes)
{
    ...
    EXPECT_EQ(result, 0) << "Should format successfully";
    EXPECT_THAT(std::string(buffer), ::testing::ContainsRegex("5 m"))
...
TEST_F(TimeFormattingTest, FormatWithHours)
{
    ...
    EXPECT_EQ(result, 0) << "Should format successfully";
    EXPECT_THAT(std::string(buffer), ::testing::ContainsRegex("2 h"))
...
TEST_F(TimeFormattingTest, FormatWithDays)
{
    ...
    EXPECT_EQ(result, 0) << "Should format successfully";
    EXPECT_THAT(std::string(buffer), ::testing::ContainsRegex("1 d"))
...
TEST_F(TimeFormattingTest, FormatComplexTime)
{
    ...
    EXPECT_EQ(result, 0) << "Should format successfully";
    EXPECT_THAT(std::string(buffer), ::testing::ContainsRegex("1 d.*2 h.*30 m.*45 s.*123.*ms"))
...
TEST_F(TimeFormattingTest, FormatZeroTime)
{
    ...
    EXPECT_EQ(result, 0) << "Should format successfully";
    EXPECT_THAT(std::string(buffer), ::testing::ContainsRegex("0"))
...
TEST_F(NullSafetyTest, FormatHandlesLargeTime)
{
    ...
    EXPECT_NE(buffer[0], '\0') << "Buffer should be populated";
    EXPECT_THAT(std::string(buffer), ::testing::ContainsRegex("999"))
