...
/** Global health agent for continual_learning module */
static nimcp_health_agent_t* g_continual_learning_health_agent = NULL;

/**
 * @brief Set health agent for continual_learning heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void continual_learning_set_health_agent(nimcp_health_agent_t* agent) {
    g_continual_learning_health_agent = agent;
}

/** @brief Send heartbeat from continual_learning module */
static inline void continual_learning_heartbeat(const char* operation, float progress) {
    if (g_continual_learning_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_continual_learning_health_agent, operation, progress);
    }
}
