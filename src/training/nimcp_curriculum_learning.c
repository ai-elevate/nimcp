...
/** Global health agent for curriculum_learning module */
static nimcp_health_agent_t* g_curriculum_learning_health_agent = NULL;

/**
 * @brief Set health agent for curriculum_learning heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void curriculum_learning_set_health_agent(nimcp_health_agent_t* agent) {
    g_curriculum_learning_health_agent = agent;
}

/** @brief Send heartbeat from curriculum_learning module */
static inline void curriculum_learning_heartbeat(const char* operation, float progress) {
    if (g_curriculum_learning_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_curriculum_learning_health_agent, operation, progress);
    }
}
