...
/** Global health agent for knowledge_distillation module */
static nimcp_health_agent_t* g_knowledge_distillation_health_agent = NULL;

/**
 * @brief Set health agent for knowledge_distillation heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void knowledge_distillation_set_health_agent(nimcp_health_agent_t* agent) {
    g_knowledge_distillation_health_agent = agent;
}

/** @brief Send heartbeat from knowledge_distillation module */
static inline void knowledge_distillation_heartbeat(const char* operation, float progress) {
    if (g_knowledge_distillation_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_knowledge_distillation_health_agent, operation, progress);
    }
}
