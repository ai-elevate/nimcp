...
/** Global health agent for mixed_precision module */
static nimcp_health_agent_t* g_mixed_precision_health_agent = NULL;

/**
 * @brief Set health agent for mixed_precision heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void mixed_precision_set_health_agent(nimcp_health_agent_t* agent) {
    g_mixed_precision_health_agent = agent;
}

/** @brief Send heartbeat from mixed_precision module */
static inline void mixed_precision_heartbeat(const char* operation, float progress) {
    if (g_mixed_precision_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_mixed_precision_health_agent, operation, progress);
    }
}
