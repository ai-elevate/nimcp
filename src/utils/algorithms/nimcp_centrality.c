...
/** Global health agent for centrality module */
static nimcp_health_agent_t* g_centrality_health_agent = NULL;

/**
 * @brief Set health agent for centrality heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void centrality_set_health_agent(nimcp_health_agent_t* agent) {
    g_centrality_health_agent = agent;
}

/** @brief Send heartbeat from centrality module */
static inline void centrality_heartbeat(const char* operation, float progress) {
    if (g_centrality_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_centrality_health_agent, operation, progress);
    }
}
