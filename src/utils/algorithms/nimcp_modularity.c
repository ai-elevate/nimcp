...
/** Global health agent for modularity module */
static nimcp_health_agent_t* g_modularity_health_agent = NULL;

/**
 * @brief Set health agent for modularity heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void modularity_set_health_agent(nimcp_health_agent_t* agent) {
    g_modularity_health_agent = agent;
}

/** @brief Send heartbeat from modularity module */
static inline void modularity_heartbeat(const char* operation, float progress) {
    if (g_modularity_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_modularity_health_agent, operation, progress);
    }
}
