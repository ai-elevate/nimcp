...
/** Global health agent for btree module */
static nimcp_health_agent_t* g_btree_health_agent = NULL;

/**
 * @brief Set health agent for btree heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void btree_set_health_agent(nimcp_health_agent_t* agent) {
    g_btree_health_agent = agent;
}

/** @brief Send heartbeat from btree module */
static inline void btree_heartbeat(const char* operation, float progress) {
    if (g_btree_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_btree_health_agent, operation, progress);
    }
}
