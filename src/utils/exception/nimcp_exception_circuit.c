...
/** Global health agent for exception_circuit module */
static nimcp_health_agent_t* g_exception_circuit_health_agent = NULL;

/**
 * @brief Set health agent for exception_circuit heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void exception_circuit_set_health_agent(nimcp_health_agent_t* agent) {
    g_exception_circuit_health_agent = agent;
}

/** @brief Send heartbeat from exception_circuit module */
static inline void exception_circuit_heartbeat(const char* operation, float progress) {
    if (g_exception_circuit_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_exception_circuit_health_agent, operation, progress);
    }
}
