...
/** Global health agent for async_checkpoint module */
static nimcp_health_agent_t* g_async_checkpoint_health_agent = NULL;

/**
 * @brief Set health agent for async_checkpoint heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void async_checkpoint_set_health_agent(nimcp_health_agent_t* agent) {
    g_async_checkpoint_health_agent = agent;
}

/** @brief Send heartbeat from async_checkpoint module */
static inline void async_checkpoint_heartbeat(const char* operation, float progress) {
    if (g_async_checkpoint_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_async_checkpoint_health_agent, operation, progress);
    }
}
