...
/** Global health agent for cognitive_recovery module */
static nimcp_health_agent_t* g_cognitive_recovery_health_agent = NULL;

/**
 * @brief Set health agent for cognitive_recovery heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void cognitive_recovery_set_health_agent(nimcp_health_agent_t* agent) {
    g_cognitive_recovery_health_agent = agent;
}

/** @brief Send heartbeat from cognitive_recovery module */
static inline void cognitive_recovery_heartbeat(const char* operation, float progress) {
    if (g_cognitive_recovery_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_cognitive_recovery_health_agent, operation, progress);
    }
}
