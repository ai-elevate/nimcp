...
/** Global health agent for fault_state_machine module */
static nimcp_health_agent_t* g_fault_state_machine_health_agent = NULL;

/**
 * @brief Set health agent for fault_state_machine heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void fault_state_machine_set_health_agent(nimcp_health_agent_t* agent) {
    g_fault_state_machine_health_agent = agent;
}

/** @brief Send heartbeat from fault_state_machine module */
static inline void fault_state_machine_heartbeat(const char* operation, float progress) {
    if (g_fault_state_machine_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_fault_state_machine_health_agent, operation, progress);
    }
}
