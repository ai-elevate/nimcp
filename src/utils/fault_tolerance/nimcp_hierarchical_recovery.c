...
/** Global health agent for hierarchical_recovery module */
static nimcp_health_agent_t* g_hierarchical_recovery_health_agent = NULL;

/**
 * @brief Set health agent for hierarchical_recovery heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void hierarchical_recovery_set_health_agent(nimcp_health_agent_t* agent) {
    g_hierarchical_recovery_health_agent = agent;
}

/** @brief Send heartbeat from hierarchical_recovery module */
static inline void hierarchical_recovery_heartbeat(const char* operation, float progress) {
    if (g_hierarchical_recovery_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_hierarchical_recovery_health_agent, operation, progress);
    }
}
