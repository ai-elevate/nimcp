...
/** Global health agent for plasticity_anomaly_detection module */
static nimcp_health_agent_t* g_plasticity_anomaly_detection_health_agent = NULL;

/**
 * @brief Set health agent for plasticity_anomaly_detection heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void plasticity_anomaly_detection_set_health_agent(nimcp_health_agent_t* agent) {
    g_plasticity_anomaly_detection_health_agent = agent;
}

/** @brief Send heartbeat from plasticity_anomaly_detection module */
static inline void plasticity_anomaly_detection_heartbeat(const char* operation, float progress) {
    if (g_plasticity_anomaly_detection_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_plasticity_anomaly_detection_health_agent, operation, progress);
    }
}
