...
/** Global health agent for complex_math module */
static nimcp_health_agent_t* g_complex_math_health_agent = NULL;

/**
 * @brief Set health agent for complex_math heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void complex_math_set_health_agent(nimcp_health_agent_t* agent) {
    g_complex_math_health_agent = agent;
}

/** @brief Send heartbeat from complex_math module */
static inline void complex_math_heartbeat(const char* operation, float progress) {
    if (g_complex_math_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_complex_math_health_agent, operation, progress);
    }
}
