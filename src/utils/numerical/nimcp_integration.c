...
/** Global health agent for integration module */
static nimcp_health_agent_t* g_integration_health_agent = NULL;

/**
 * @brief Set health agent for integration heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void integration_set_health_agent(nimcp_health_agent_t* agent) {
    g_integration_health_agent = agent;
}

/** @brief Send heartbeat from integration module */
static inline void integration_heartbeat(const char* operation, float progress) {
    if (g_integration_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_integration_health_agent, operation, progress);
    }
}
