...
/** Global health agent for platform_thread module */
static nimcp_health_agent_t* g_platform_thread_health_agent = NULL;

/**
 * @brief Set health agent for platform_thread heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void platform_thread_set_health_agent(nimcp_health_agent_t* agent) {
    g_platform_thread_health_agent = agent;
}

/** @brief Send heartbeat from platform_thread module */
static inline void platform_thread_heartbeat(const char* operation, float progress) {
    if (g_platform_thread_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_platform_thread_health_agent, operation, progress);
    }
}
