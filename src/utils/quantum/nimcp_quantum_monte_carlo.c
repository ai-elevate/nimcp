...
/** Global health agent for quantum_monte_carlo module */
static nimcp_health_agent_t* g_quantum_monte_carlo_health_agent = NULL;

/**
 * @brief Set health agent for quantum_monte_carlo heartbeats
 * @param agent Health agent (can be NULL to disable)
 */
static void quantum_monte_carlo_set_health_agent(nimcp_health_agent_t* agent) {
    g_quantum_monte_carlo_health_agent = agent;
}

/** @brief Send heartbeat from quantum_monte_carlo module */
static inline void quantum_monte_carlo_heartbeat(const char* operation, float progress) {
    if (g_quantum_monte_carlo_health_agent) {
        nimcp_health_agent_heartbeat_ex(g_quantum_monte_carlo_health_agent, operation, progress);
    }
}
