/**
 * @file test_synapse_types_standalone.c
 * @brief Standalone test for Phase 8.7 synapse type system (no dependencies)
 */
...
// Include only the synapse types header (self-contained)
