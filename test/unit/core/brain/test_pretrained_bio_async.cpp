...
protected:
    void SetUp() override {
        ...
        // Initialize logging with correct API
        ...
        log_config.async_mode = NIMCP_LOG_ASYNC_OFF;  // Synchronous for testing
...
TEST_F(PretrainedBioAsyncTest, ModuleIDDefined) {
    ...
    // NOTE: Value is 0x0110 + 8 = 0x0118 (9th in brain submodules enum)

    EXPECT_EQ(BIO_MODULE_BRAIN_PRETRAINED, 0x0118);
}
