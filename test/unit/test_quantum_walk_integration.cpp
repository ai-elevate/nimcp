...
TEST_F(QuantumWalkIntegrationTest, QuantumSystemCreation) {
    ...
    // Verify quantum walk is enabled
    EXPECT_TRUE(field->use_quantum_walk);
    EXPECT_NE(field->quantum_walker, nullptr);
}
...
TEST_F(QuantumWalkIntegrationTest, ClassicalSystemCreation) {
    ...
    EXPECT_FALSE(field->use_quantum_walk);
    EXPECT_EQ(field->quantum_walker, nullptr);
}
